...
//add 0x40 for luigi sounds, put the sounds here
#define SOUND_LUIGI_YAH_WAH_HOO                         SOUND_ARG_LOAD(2, 4, 0x40, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_HOOHOO           SOUND_ARG_LOAD(2, 4, 0x43, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_YAHOO            SOUND_ARG_LOAD(2, 4, 0x44, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_UH               SOUND_ARG_LOAD(2, 4, 0x45, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_HRMM             SOUND_ARG_LOAD(2, 4, 0x46, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_WAH2             SOUND_ARG_LOAD(2, 4, 0x47, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_WHOA             SOUND_ARG_LOAD(2, 4, 0x48, 0xC0, 8)
/* not verified */ #define SOUND_LUIGI_EEUH             SOUND_ARG_LOAD(2, 4, 0x49, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_ATTACKED         SOUND_ARG_LOAD(2, 4, 0x4A, 0xFF, 8)
/* not verified */ #define SOUND_LUIGI_OOOF             SOUND_ARG_LOAD(2, 4, 0x4B, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_OOOF2            SOUND_ARG_LOAD(2, 4, 0x4B, 0xD0, 8)
#define SOUND_LUIGI_HERE_WE_GO                          SOUND_ARG_LOAD(2, 4, 0x4C, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_YAWNING          SOUND_ARG_LOAD(2, 4, 0x4D, 0x80, 8)
#define SOUND_LUIGI_SNORING1                            SOUND_ARG_LOAD(2, 4, 0x4E, 0x80, 8)
#define SOUND_LUIGI_SNORING2                            SOUND_ARG_LOAD(2, 4, 0x4F, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_WAAAOOOW         SOUND_ARG_LOAD(2, 4, 0x50, 0xC0, 8)
/* not verified */ #define SOUND_LUIGI_HAHA             SOUND_ARG_LOAD(2, 4, 0x51, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_HAHA_2           SOUND_ARG_LOAD(2, 4, 0x51, 0xF0, 8)
/* not verified */ #define SOUND_LUIGI_UH2              SOUND_ARG_LOAD(2, 4, 0x53, 0xD0, 8)
/* not verified */ #define SOUND_LUIGI_UH2_2            SOUND_ARG_LOAD(2, 4, 0x53, 0x80, 8)
/* not verified */ #define SOUND_LUIGI_ON_FIRE          SOUND_ARG_LOAD(2, 4, 0x54, 0xA0, 8)
/* not verified */ #define SOUND_LUIGI_DYING            SOUND_ARG_LOAD(2, 4, 0x55, 0xFF, 8)
#define SOUND_LUIGI_PANTING_COLD                        SOUND_ARG_LOAD(2, 4, 0x56, 0x80, 8)

// A random number 0-2 is added to the sound ID before playing
#define SOUND_LUIGI_PANTING                     SOUND_ARG_LOAD(2, 4, 0x58, 0x80, 8)

#define SOUND_LUIGI_COUGHING1                   SOUND_ARG_LOAD(2, 4, 0x5B, 0x80, 8)
#define SOUND_LUIGI_COUGHING2                   SOUND_ARG_LOAD(2, 4, 0x5C, 0x80, 8)
#define SOUND_LUIGI_COUGHING3                   SOUND_ARG_LOAD(2, 4, 0x5D, 0x80, 8)
#define SOUND_LUIGI_PUNCH_YAH                   SOUND_ARG_LOAD(2, 4, 0x5E, 0x80, 8)
#define SOUND_LUIGI_PUNCH_HOO                   SOUND_ARG_LOAD(2, 4, 0x5F, 0x80, 8)
#define SOUND_LUIGI_MAMA_MIA                    SOUND_ARG_LOAD(2, 4, 0x60, 0x80, 8)
#define SOUND_LUIGI_OKEY_DOKEY                  0x2061
#define SOUND_LUIGI_GROUND_POUND_WAH            SOUND_ARG_LOAD(2, 4, 0x62, 0x80, 8)
#define SOUND_LUIGI_DROWNING                    SOUND_ARG_LOAD(2, 4, 0x63, 0xF0, 8)
#define SOUND_LUIGI_PUNCH_WAH                   SOUND_ARG_LOAD(2, 4, 0x64, 0x80, 8)

#define SOUND_LUIGI_YAHOO_WAHA_YIPPEE           SOUND_ARG_LOAD(2, 4, 0x6B, 0x80, 8)

#define SOUND_LUIGI_DOH                         SOUND_ARG_LOAD(2, 4, 0x70, 0x80, 8)
#define SOUND_LUIGI_GAME_OVER                   SOUND_ARG_LOAD(2, 4, 0x71, 0xFF, 8)
#define SOUND_LUIGI_HELLO                       SOUND_ARG_LOAD(2, 4, 0x72, 0xFF, 8)
#define SOUND_LUIGI_PRESS_START_TO_PLAY         SOUND_ARG_LOAD(2, 4, 0x73, 0xFF, 0xA)
#define SOUND_LUIGI_TWIRL_BOUNCE                SOUND_ARG_LOAD(2, 4, 0x74, 0x80, 8)
#define SOUND_LUIGI_SNORING3                    SOUND_ARG_LOAD(2, 4, 0x75, 0xFF, 8)
#define SOUND_LUIGI_SO_LONGA_BOWSER             SOUND_ARG_LOAD(2, 4, 0x76, 0x80, 8)
#define SOUND_LUIGI_IMA_TIRED                   SOUND_ARG_LOAD(2, 4, 0x77, 0x80, 8)
