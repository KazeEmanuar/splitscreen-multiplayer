...
void func_8029A87C(struct Object *o, f32 b, f32 c) {
    ...
    vec3f_get_dist_and_angle(gCameraStatus[0].pos, gCameraStatus[0].focus, &sp24, &sp2A, &sp28);
    vec3f_set_dist_and_angle(gCameraStatus[0].pos, sp2C, o->oIntroPeachUnk110, o->oIntroPeachUnk10C + sp2A,
