...
void func_802AC0B8(void) {
    if (segmented_to_virtual(bhvDoor) == o->behavior)
        gPlayerStatusForCamera[gMarioObject->oAnimState].unk1C[1] = 6;
    else
        gPlayerStatusForCamera[gMarioObject->oAnimState].unk1C[1] = 5;
    gPlayerStatusForCamera[gMarioObject->oAnimState].usedObj = o;
}
