...
// sorted
extern struct CameraPlayerStatus *sMarioStatusForCamera;
extern struct CameraPlayerStatus *sLuigiStatusForCamera;
...
extern struct CameraState gCameraStatus[2];
extern s16 gCameraMovementFlags[2];
extern s32 gCutsceneActive[];
extern struct LevelCamera *gCurrLevelCamera;
#endif

extern struct Object *gCutsceneFocus[2];
extern struct Object *gSecondCameraFocus[2];
...
extern void instant_warp_camera_update(f32, f32, f32, struct MarioState *);
...
extern void set_fov_function(u8, struct LevelCamera *);
extern void func_8029A494(u8 , struct LevelCamera *);
