...
// turn these into arrays for each camera seperately
// BSS
struct CameraPlayerStatus gPlayerStatusForCamera[2];
Vec3f sCameraPosition[2];
Vec3f sCameraFocus[2];
Vec3f D_8033B218[2];
s16 sCreditsCameraPitch[2];
s16 sCreditsCameraYaw[2];
u8 gFramesPaused;
struct Struct8033B230 D_8033B230[2];
struct TransitionCamera sCameraTransition[2];
struct PlayerGeometry sGeometryForMario[2];
s16 sCameraYawVelocity[2];
s16 sCameraYawAfterDoorCutscene[2];
struct Struct8033B2B8 sSplineParameters[4][2];
s16 sSplineParameterMax[2];
f32 sPositionAlongSpline[2];
f32 sSplinePositionLimit[2];
s16 sCameraCutscenePitchOffset[2];
s16 sCameraCutsceneYawOffset[2];
s16 sCameraCutsceneRollOffset[2];
s16 gCameraModeFlags[2];
s16 sCameraSideCFlags[2];
s16 gCameraFlags1[2];
u16 gCButtonsPressed[2];
s16 D_8033B320[2];
struct CameraState gCameraStatus[2];
s16 sYawFocToMario[2];
s16 D_8033B3EC[2];
s16 D_8033B3EE[2];
s16 D_8033B3F0[2];
f32 D_8033B3F4[2];
s16 sCSideButtonYaw[2];
s16 D_8033B3FA[2];
f32 D_8033B3FC[2];
s16 sFirstPersonCameraPitch[2];
s16 sFirstPersonCameraYaw[2];
s16 D_8033B404[2];
s16 sPlatformLevelPresetBaseYaw[2];
s16 gPlatformLevelYawOffset[2];
f32 D_8033B40C[2];
f32 D_8033B410[2];
struct Struct8033B418 D_8033B418[2];
Vec3f sFixedPresetBasePositionOffset[2];
u32 D_8033B46C[2];
struct ParallelTrackingTable *D_8033B470[2];
struct Struct8033B4B8 D_8033B478[2];
struct Struct8033B4B8 D_8033B498[2];
struct Struct8033B4B8 D_8033B4B8[2];
s16 gCameraMovementFlags[2];
s16 gCameraFlags2[2];
struct CinematicCameraTable D_8033B4E0[2][32];
struct CinematicCameraTable D_8033B5E0[2][32];
s16 D_8033B6E0[2];
f32 D_8033B6E4[2];
s16 D_8033B6E8[2];
s16 D_8033B6EA[2];
s16 gCutsceneTimer[2];
struct Struct8033B6F0 D_8033B6F0[10][2];
s32 gCutsceneActive[2];
u32 sCutscenePhase[2];
struct LevelCamera *gCurrLevelCamera; // dont do this

// first iteration of data, ignore the constant numbers, but split some of these?
struct Object *gCutsceneFocus[2] = { NULL, NULL };
struct Object *gSecondCameraFocus[2] = { NULL, NULL };
s16 D_8032CFD4[2] = { 1024, 1024 };
s32 gCurrLevelArea = 0;
u32 gPrevLevel = 0;
f32 gCameraZoomDist[2] = { 800.0f, 800.0f };
u8 sTempCutsceneNumber[2] = { 0, 0 };
u8 gCutsceneNumber[2] = { 0, 0 }; // KEEP GOING HERE
u8 sCutsceneTransitionTimer[2] = { 0, 0 };
u8 D_8032CFFC[2] = { 0, 0 };
...
Vec3f sFixedPresetBasePosition[2] = { { 646.0f, 143.0f, -1513.0f }, { 646.0f, 143.0f, -1513.0f } };
int areaWarped = 0;
...
void set_camera_shake(s16 shake, struct LevelCamera *c) {
    ...
    switch (shake) {
        case SHAKE_ATTACK:
            gCameraStatus[c->cameraID].unkA4 = 0;
            gCameraStatus[c->cameraID].unkAC = 0;
            break;

        case SHAKE_FALL_DAMAGE:
            set_camera_pitch_shake(0x60, 0x3, 0x8000, c);
            set_camera_roll_shake(0x60, 0x3, 0x8000, c);
            break;

        case SHAKE_GROUND_POUND:
            set_camera_pitch_shake(0x60, 0xC, 0x8000, c);
            break;

        case SHAKE_SMALL_DAMAGE:
            if ((&gPlayerStatusForCamera[c->cameraID])->action
                & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER)) {
                set_camera_yaw_shake(0x200, 0x10, 0x1000, c);
                set_camera_roll_shake(0x400, 0x20, 0x1000, c);
                func_80299C98(0x100, 0x30, -0x8000, c);
            } else {
                set_camera_yaw_shake(0x80, 0x8, 0x4000, c);
                set_camera_roll_shake(0x80, 0x8, 0x4000, c);
                func_80299C98(0x100, 0x30, -0x8000, c);
            }
        ...
        case SHAKE_MED_DAMAGE:
            if ((&gPlayerStatusForCamera[c->cameraID])->action
                & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER)) {
                set_camera_yaw_shake(0x400, 0x20, 0x1000, c);
                set_camera_roll_shake(0x600, 0x30, 0x1000, c);
                func_80299C98(0x180, 0x40, -0x8000, c);
            } else {
                set_camera_yaw_shake(0x100, 0x10, 0x4000, c);
                set_camera_roll_shake(0x100, 0x10, 0x4000, c);
                func_80299C98(0x180, 0x40, -0x8000, c);
            }
        ...
        case SHAKE_LARGE_DAMAGE:
            if ((&gPlayerStatusForCamera[c->cameraID])->action
                & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER)) {
                set_camera_yaw_shake(0x600, 0x30, 0x1000, c);
                set_camera_roll_shake(0x800, 0x40, 0x1000, c);
                func_80299C98(0x200, 0x50, -0x8000, c);
            } else {
                set_camera_yaw_shake(0x180, 0x20, 0x4000, c);
                set_camera_roll_shake(0x200, 0x20, 0x4000, c);
                func_80299C98(0x200, 0x50, -0x8000, c);
            }
        ...
        case SHAKE_HIT_FROM_BELOW:
            gCameraStatus[c->cameraID].unkA4 = 0.07;
            gCameraStatus[c->cameraID].unkAC = 0.07;
            break;

        case SHAKE_SHOCK:
            set_camera_pitch_shake(RandomFloat() * 64.f, 0x8, 0x8000, c);
            set_camera_yaw_shake(RandomFloat() * 64.f, 0x8, 0x8000, c);
            break;
    }
}

void set_camera_shake_2(s16 shake, struct LevelCamera *c) {
    switch (shake) {
        case SHAKE_2_UNKNOWN_1:
            set_camera_pitch_shake(0x60, 0x8, 0x4000, c);
            break;

        case SHAKE_2_UNKNOWN_2:
            set_camera_pitch_shake(0xC0, 0x8, 0x4000, c);
            break;

        case SHAKE_2_UNKNOWN_3:
            set_camera_pitch_shake(0x100, 0x8, 0x3000, c);
            break;

        case SHAKE_2_UNKNOWN_6:
            set_camera_roll_shake(0x80, 0x10, 0x3000, c);
            break;

        case SHAKE_2_UNKNOWN_7:
            set_camera_pitch_shake(0x20, 0x8, 0x8000, c);
            break;

        case SHAKE_2_UNKNOWN_8:
            set_camera_pitch_shake(0x40, 0x8, 0x8000, c);
            break;

        case SHAKE_2_JRB_SHIP_DRAIN:
            set_camera_pitch_shake(0x20, 0x8, 0x8000, c);
            set_camera_roll_shake(0x400, 0x10, 0x100, c);
            break;

        case SHAKE_2_FALLING_BITS_PLAT:
            set_camera_pitch_shake(64, 0x2, 0x8000, c);
            break;

        case SHAKE_2_UNKNOWN_5:
            set_camera_yaw_shake(-0x200, 0x80, 0x200, c);
            break;
    }
}
...
void return_height_above_floor(f32 *a, f32 b, f32 c, f32 *d, f32 e, f32 f) {
    f32 floorHeight = sGeometryForMario[gCurrLevelCamera->cameraID].currFloorHeight;
    f32 waterHeight;
    UNUSED s32 filler;

    if (!((&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->action & ACT_FLAG_METAL_WATER)) {
        if (floorHeight < (waterHeight = find_water_level(
                               (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[0],
                               (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[2]))) {
            floorHeight = waterHeight;
        }
    }

    if ((&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->action & ACT_FLAG_ON_POLE) {
        if (sGeometryForMario[gCurrLevelCamera->cameraID].currFloorHeight
                >= gMarioStates[gCurrLevelCamera->cameraID].usedObj->oPosY
            && (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1]
                   < 0.7f * gMarioStates[gCurrLevelCamera->cameraID].usedObj->hitboxHeight
                         + gMarioStates[gCurrLevelCamera->cameraID].usedObj->oPosY) {
            c = 1200;
        }
    }

    *a = (floorHeight - (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1]) * b;
    ...
    *d = (floorHeight - (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1]) * e;
...
void set_cam_focus_and_pos_rel_mario(Vec3f a, Vec3f b, f32 c, f32 d, f32 e, s16 f, s16 g) {
    ...
    sp24[0] = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[0];
    sp24[1] = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1] + c;
    sp24[2] = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[2];

    vec3f_set_dist_and_angle(sp24, b, e, f + D_8033B3F0[gCurrLevelCamera->cameraID], g);

    a[0] = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[0];
    a[1] = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1] + d;
    a[2] = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[2];
}
...
void set_camera_height(struct LevelCamera *c, f32 goalHeight) {
    ...
    f32 camFloorHeight;
    UNUSED u8 filler[8];
    UNUSED s16 action = (&gPlayerStatusForCamera[c->cameraID])->action;
    f32 sp28 = 125.f;
    f32 camCeilHeight =
        find_ceil(c->pos[0], gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1] - 50.f, c->pos[2],
                  &surface);

    if ((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_HANGING) {
        marioCeilHeight = sGeometryForMario[c->cameraID].currCeilHeight;
        marioFloorHeight = sGeometryForMario[c->cameraID].currFloorHeight;
        ...
        if ((&gPlayerStatusForCamera[c->cameraID])->pos[1] - 400 > goalHeight) {
            goalHeight = (&gPlayerStatusForCamera[c->cameraID])->pos[1] - 400;
        }

        approach_camera_height(c, goalHeight, 5.f);
    } else {
        camFloorHeight = find_floor(c->pos[0], c->pos[1] + 100.f, c->pos[2], &surface) + sp28;
        marioFloorHeight = sp28 + sGeometryForMario[c->cameraID].currFloorHeight;
        ...
        if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_BUTT_STUCK_IN_GROUND
            || (&gPlayerStatusForCamera[c->cameraID])->action == ACT_HEAD_STUCK_IN_GROUND
            || (&gPlayerStatusForCamera[c->cameraID])->action == ACT_FEET_STUCK_IN_GROUND) {
        ...
        if (camCeilHeight != 20000.f) {
            ...
            if ((c->pos[1] > camCeilHeight
                 && sGeometryForMario[c->cameraID].currFloorHeight + sp28 < camCeilHeight)
                || (sGeometryForMario[c->cameraID].currCeilHeight != 20000.f
                    && sGeometryForMario[c->cameraID].currCeilHeight > camCeilHeight
...
s16 return_pitch_parallel_floor(s16 yaw) {
    ...
    f32 floorHeight;
    s16 pitch = 0x05B0;
    f32 xPos = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[0] + sins(yaw) * 40.f;
    f32 zPos = (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[2] + coss(yaw) * 40.f;

    floorHeight =
        find_floor(xPos, (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1], zPos, &floor)
        - (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1];
...
void func_8027FF44(struct LevelCamera *c) {
    ...
    vec3f_get_dist_and_angle(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, &camDistToMario,
                             &camPitchToMario, &camYawToMario);

    sp24[2] = sins(0xC00) * camDistToMario;

    rotate_in_xz(sp24, sp24, (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1]);
    camYawToMario = -camYawToMario;
    rotate_in_xz(sp24, sp24, camYawToMario);
    sp24[2] = 0.f;

    if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_LONG_JUMP
        || ((&gPlayerStatusForCamera[c->cameraID])->action != ACT_TOP_OF_POLE
            && ((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_ON_POLE))) {
        sp24[0] = -sp24[0];
    }
    if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_SLEEPING) {
        approach_f32_exponential_bool(&D_8033B40C[c->cameraID], 0.f, 0.025f);
    } else {
        approach_f32_exponential_bool(&D_8033B40C[c->cameraID], sp24[0], 0.025f);
    }
    sp24[0] = D_8033B40C[c->cameraID];
    camYawToMario = -camYawToMario;
    rotate_in_xz(sp24, sp24, camYawToMario);
...
s32 return_open_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    f32 xDistFocToMario = (&gPlayerStatusForCamera[c->cameraID])->pos[0] - c->xFocus;
    f32 zDistFocToMario = (&gPlayerStatusForCamera[c->cameraID])->pos[2] - c->zFocus;
    s16 yaw = atan2s(zDistFocToMario, xDistFocToMario) + sFirstPersonCameraYaw[c->cameraID];
    ...
    sYawFocToMario[c->cameraID] = yaw - sFirstPersonCameraYaw[c->cameraID];
    ...
    set_cam_focus_and_pos_rel_mario(focus, pos, posHeightAboveFloor + yOffset,
                                    focusHeightAboveFloor + yOffset, D_8033B3EE[c->cameraID] + sp28,
                                    pitch, yaw);
...
s32 return_platform_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    UNUSED f32 xDistFocToMario = (&gPlayerStatusForCamera[c->cameraID])->pos[0] - c->xFocus;
    UNUSED f32 zDistFocToMario = (&gPlayerStatusForCamera[c->cameraID])->pos[2] - c->zFocus;
    s16 yaw = sPlatformLevelPresetBaseYaw[c->cameraID] + gPlatformLevelYawOffset[c->cameraID];
    s16 pitch = return_pitch_parallel_floor(yaw);
    f32 posHeightAboveFloor;
    f32 focusHeightAboveFloor;
    UNUSED f32 unused1;
...
void func_80280550(struct LevelCamera *c) {
    ...
    f32 zDistFocToMario = (&gPlayerStatusForCamera[c->cameraID])->pos[2] - c->zFocus;
    UNUSED s32 filler;
    s16 sp26 = calculate_yaw((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos)
               - atan2s(zDistFocToMario, xDistFocToMario);
    ...
    if (!(gCameraMovementFlags[c->cameraID]
          & (CAM_MOVE_RETURN_TO_MIDDLE | CAM_MOVE_ROTATE_RIGHT | CAM_MOVE_ROTATE_LEFT))) {
        if (sGeometryForMario[c->cameraID].currFloorType == SURFACE_CAMERA_MIDDLE
            && sGeometryForMario[c->cameraID].prevFloorType != SURFACE_CAMERA_MIDDLE) {
            gCameraMovementFlags[c->cameraID] |= (CAM_MOVE_RETURN_TO_MIDDLE | CAM_MOVE_UNKNOWN_5);
        }
        if (sGeometryForMario[c->cameraID].currFloorType == SURFACE_CAMERA_ROTATE_RIGHT
            && sGeometryForMario[c->cameraID].prevFloorType != SURFACE_CAMERA_ROTATE_RIGHT) {
            gCameraMovementFlags[c->cameraID] |= (CAM_MOVE_ROTATE_RIGHT | CAM_MOVE_UNKNOWN_5);
        }
        if (sGeometryForMario[c->cameraID].currFloorType == SURFACE_CAMERA_ROTATE_LEFT
            && sGeometryForMario[c->cameraID].prevFloorType != SURFACE_CAMERA_ROTATE_LEFT) {
            gCameraMovementFlags[c->cameraID] |= (CAM_MOVE_ROTATE_LEFT | CAM_MOVE_UNKNOWN_5);
        }
    }

    if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_UNKNOWN_5) {
        sp42 = 512;
    }
    ...
    if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_RETURN_TO_MIDDLE) {
        if (camera_approach_s16_symmetric_bool(&sFirstPersonCameraYaw[c->cameraID], 0, sp42) == 0) {
            gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_RETURN_TO_MIDDLE;
        }
    } else {
        if ((gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_RIGHT) && sp3C == 3
            && sp40 + 16 < sFirstPersonCameraYaw[c->cameraID]) {
            sFirstPersonCameraYaw[c->cameraID] = sp40;
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_ROTATE_RIGHT | CAM_MOVE_UNKNOWN_5);
        }
        if ((gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_LEFT) && sp3C == 3
            && sp40 - 16 > sFirstPersonCameraYaw[c->cameraID]) {
            sFirstPersonCameraYaw[c->cameraID] = sp40;
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_ROTATE_LEFT | CAM_MOVE_UNKNOWN_5);
        }
        if (!(sCameraSideCFlags[c->cameraID] & 4)
            && (gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_RIGHT)
            && camera_approach_s16_symmetric_bool(&sFirstPersonCameraYaw[c->cameraID], sp46, sp42)
                   == 0) {
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_ROTATE_RIGHT | CAM_MOVE_UNKNOWN_5);
        }
        if (!(sCameraSideCFlags[c->cameraID] & 8)
            && (gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_LEFT)
            && camera_approach_s16_symmetric_bool(&sFirstPersonCameraYaw[c->cameraID], sp44, sp42)
                   == 0) {
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_ROTATE_LEFT | CAM_MOVE_UNKNOWN_5);
        }
        if ((sCameraSideCFlags[c->cameraID] & 4)
            && (gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_RIGHT)
            && camera_approach_s16_symmetric_bool(&sFirstPersonCameraYaw[c->cameraID], 19114, sp42)
                   == 0) {
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_ROTATE_RIGHT | CAM_MOVE_UNKNOWN_5);
            sCameraSideCFlags[c->cameraID] &= ~4;
        }
        if ((sCameraSideCFlags[c->cameraID] & 8)
            && (gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_LEFT)
            && camera_approach_s16_symmetric_bool(&sFirstPersonCameraYaw[c->cameraID], -19114, sp42)
                   == 0) {
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_ROTATE_LEFT | CAM_MOVE_UNKNOWN_5);
            sCameraSideCFlags[c->cameraID] &= ~8;
        }
    }
    if (!(gCameraMovementFlags[c->cameraID]
          & (CAM_MOVE_RETURN_TO_MIDDLE | CAM_MOVE_ROTATE_RIGHT | CAM_MOVE_ROTATE_LEFT))) {
        if (sp3C == 3) {
            approach_s16_exponential_bool(&sFirstPersonCameraYaw[c->cameraID], sp40, 10);
        } else {
            if (c->currPreset == CAMERA_PRESET_OPEN_CAMERA) {
                sp42 = gMarioStates[c->cameraID].forwardVel / 32.f * 128.f;
                camera_approach_s16_symmetric_bool(&sFirstPersonCameraYaw[c->cameraID], sp26, sp42);
            }
            if (c->currPreset == CAMERA_PRESET_REVERSE_TOWER) {
                sFirstPersonCameraYaw[c->cameraID] =
                    func_8028AF24(c, atan2s(zDistFocToMario, xDistFocToMario));
            }
        }
    }

    if (sFirstPersonCameraYaw[c->cameraID] >= 0x5555) {
        sFirstPersonCameraYaw[c->cameraID] = 21844;
    }
    if (sFirstPersonCameraYaw[c->cameraID] < -0x5554) {
        sFirstPersonCameraYaw[c->cameraID] = -21844;
    }
}

void func_80280BD8(f32 a, s16 b) { // this function is fine using gcurrlevelcamera
    if (D_8033B3EE[gCurrLevelCamera->cameraID] < 0) {
        if ((D_8033B3EE[gCurrLevelCamera->cameraID] += 30) > 0) {
            D_8033B3EE[gCurrLevelCamera->cameraID] = 0;
        }
    } else if (a < D_8033B3EE[gCurrLevelCamera->cameraID]) {
        if ((D_8033B3EE[gCurrLevelCamera->cameraID] -= 30) < a) {
            D_8033B3EE[gCurrLevelCamera->cameraID] = a;
        }
    } else if (gCameraMovementFlags[gCurrLevelCamera->cameraID] & CAM_MOVE_ZOOMED_OUT) {
        if ((D_8033B3EE[gCurrLevelCamera->cameraID] += 30) > a) {
            D_8033B3EE[gCurrLevelCamera->cameraID] = a;
        }
    } else {
    ...
    if (gCameraMovementFlags[gCurrLevelCamera->cameraID] & CAM_MOVE_ZOOMED_OUT) {
        if ((D_8033B3F0[gCurrLevelCamera->cameraID] += b / 13) > b) {
            D_8033B3F0[gCurrLevelCamera->cameraID] = b;
        }
    } else {
        if ((D_8033B3F0[gCurrLevelCamera->cameraID] -= b / 13) < 0) {
            D_8033B3F0[gCurrLevelCamera->cameraID] = 0;
        }
    }
}
...
void func_80280E3C(UNUSED struct LevelCamera *c) {
    ...
    sFirstPersonCameraYaw[c->cameraID] =
        D_8033B418[c->cameraID].unk8.unk1E - sYawFocToMario[c->cameraID];
    D_8033B3EE[c->cameraID] = D_8033B418[c->cameraID].unk8.unk18 - sp4;
    gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_INTO_C_UP;
}

void update_open_camera(struct LevelCamera *c) {
    Vec3f pos;
    UNUSED u8 unused1[8];
    s16 sp22 = sYawFocToMario[c->cameraID];
    UNUSED u8 unused2[4];

    if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_INTO_C_UP) {
        func_80280E3C(c);
    }
    ...
    c->pos[0] = pos[0];
    c->pos[2] = pos[2];
    D_8033B3EC[c->cameraID] = sYawFocToMario[c->cameraID] - sp22;
    if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_RIDING_HOOT) {
        pos[1] += 500.f;
    }
...
void update_platform_level_camera(struct LevelCamera *c) {
    Vec3f pos;
    UNUSED u8 unused[8];
    s16 sp1A = sYawFocToMario[c->cameraID];

    func_8028B3DC(c, 0.f);

    if (c->controller->buttonPressed & R_CBUTTONS) {
        gPlatformLevelYawOffset[c->cameraID] += 0x2000;
        play_sound_cbutton_side();
    }
    if (c->controller->buttonPressed & L_CBUTTONS) {
        gPlatformLevelYawOffset[c->cameraID] -= 0x2000;
        play_sound_cbutton_side();
    }
    ...
    c->pos[0] = pos[0];
    c->pos[2] = pos[2];
    D_8033B3EC[c->cameraID] = sYawFocToMario[c->cameraID] - sp1A;
    set_camera_height(c, pos[1]);
    if (gMarioStates[c->cameraID].action == ACT_BUBBLED) {
        set_camera_height(c, pos[1]);
        set_camera_height(c, pos[1]);
    }
}
...
s32 return_reverse_tower_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    f32 xDistFocToMario = (&gPlayerStatusForCamera[c->cameraID])->pos[0] - c->xFocus;
    f32 zDistFocToMario = (&gPlayerStatusForCamera[c->cameraID])->pos[2] - c->zFocus;
    s16 yaw = atan2s(zDistFocToMario, xDistFocToMario) + sFirstPersonCameraYaw[c->cameraID] + 0x8000;
    s16 pitch = return_pitch_parallel_floor(yaw);
    f32 sp38 = 1000.f;
    f32 yOffset = 125.f;
    f32 posHeightAboveFloor;
    ...
    sYawFocToMario[c->cameraID] = yaw - sFirstPersonCameraYaw[c->cameraID] - 0x8000;
    return_height_above_floor(&posHeightAboveFloor, 1.f, 200.f, &focusHeightAboveFloor, 0.9f, 200.f);
    set_cam_focus_and_pos_rel_mario(focus, pos, posHeightAboveFloor + yOffset,
                                    focusHeightAboveFloor + yOffset, D_8033B3EE[c->cameraID] + sp38,
                                    pitch, yaw);
...
s32 return_parallel_tracking_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    ...
    sp60[2] = 0.f;
    vec3f_copy(sp4C, pos);
    vec3f_copy(spE8[0], D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk4);
    vec3f_copy(spE8[1], D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 1].unk4);
    spAC = D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk10;
    spA8 = D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk14;
    return_height_above_floor(&sp84, 1.f, 200.f, &sp84, 0.9f, 200.f);
    sp78[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0];
    sp78[1] = (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 150.f + sp84;
    sp78[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2];
    ...
    if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_UNKNOWN_3) {
        gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_UNKNOWN_3;
        D_8033B478[c->cameraID].pos[0] = sp4C[0] - c->pos[0];
        D_8033B478[c->cameraID].pos[1] = sp4C[1] - c->pos[1];
        D_8033B478[c->cameraID].pos[2] = sp4C[2] - c->pos[2];
    }
    approach_f32_exponential_bool(&D_8033B478[c->cameraID].pos[0], 0.f, 0.025f);
    approach_f32_exponential_bool(&D_8033B478[c->cameraID].pos[1], 0.f, 0.025f);
    approach_f32_exponential_bool(&D_8033B478[c->cameraID].pos[2], 0.f, 0.025f);
    vec3f_add(c->pos, D_8033B478[c->cameraID].pos);

    if (D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 1].unk0 != 0) {
        calculate_angles(D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 1].unk4,
                         D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 2].unk4, &sp28, &sp24);
        vec3f_set_dist_and_angle(D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 1].unk4, sp34, 400.f,
                                 sp28, sp24);
        sp2C = calc_abs_dist(sp78, sp34);
        calculate_angles(D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 1].unk4,
                         D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk4, &sp2A, &sp26);
        vec3f_set_dist_and_angle(D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 1].unk4, sp40, 400.f,
                                 sp2A, sp26);
        sp30 = calc_abs_dist(sp78, sp40);
        if (sp2C < sp30) {
            D_8033B46C[c->cameraID]++;
            gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNKNOWN_3;
        }
    }

    if (D_8033B46C[c->cameraID] != 0) {
        calculate_angles(D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk4,
                         D_8033B470[c->cameraID][D_8033B46C[c->cameraID] + 1].unk4, &sp28, &sp24);
        vec3f_set_dist_and_angle(D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk4, sp34, 700.f,
                                 sp28, sp24);
        sp2C = calc_abs_dist(sp78, sp34);
        calculate_angles(D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk4,
                         D_8033B470[c->cameraID][D_8033B46C[c->cameraID] - 1].unk4, &sp2A, &sp26);
        vec3f_set_dist_and_angle(D_8033B470[c->cameraID][D_8033B46C[c->cameraID]].unk4, sp40, 700.f,
                                 sp2A, sp26);
        sp30 = calc_abs_dist(sp78, sp40);
        if (sp2C > sp30) {
            D_8033B46C[c->cameraID]--;
...
s32 return_fixed_camera_yaw(struct LevelCamera *c, Vec3f focus, UNUSED Vec3f pos) {
    ...
    play_camera_buzz_if_cdown(c);

    return_height_above_floor(&heightAboveFloor, 1.f, 200.f, &heightAboveFloor, 0.9f, 200.f);
    vec3f_copy(focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    focus[1] += heightAboveFloor + 125.f;
    vec3f_get_dist_and_angle(focus, c->pos, &distCamToFocus, &faceAngle[0], &faceAngle[1]);
    faceAngle[2] = 0;

    vec3f_copy(basePos, sFixedPresetBasePosition[c->cameraID]);
    vec3f_add(basePos, sFixedPresetBasePositionOffset[c->cameraID]);

    if (sGeometryForMario[c->cameraID].currFloorType != SURFACE_DEATH_PLANE
        && sGeometryForMario[c->cameraID].currFloorHeight != -11000.f) {
        goalHeight = sGeometryForMario[c->cameraID].currFloorHeight + basePos[1] + heightOffset;
    } else {
        goalHeight = gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1];
    }
    ...
    if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_SMOOTH_MOVEMENT) {
        camera_approach_f32_symmetric_bool(&c->pos[1], goalHeight, 15.f);
    } else {
        if (goalHeight < (&gPlayerStatusForCamera[c->cameraID])->pos[1] - 500.f) {
            goalHeight = (&gPlayerStatusForCamera[c->cameraID])->pos[1] - 500.f;
        }
        c->pos[1] = goalHeight;
    }

    c->pos[0] =
        basePos[0] + ((&gPlayerStatusForCamera[c->cameraID])->pos[0] - basePos[0]) * scaleToMario;
    c->pos[2] =
        basePos[2] + ((&gPlayerStatusForCamera[c->cameraID])->pos[2] - basePos[2]) * scaleToMario;
...
s32 return_boss_fight_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    ...
    if ((&gPlayerStatusForCamera[c->cameraID])->unk1C[1] == 7) {
        set_camera_shake_2(SHAKE_2_UNKNOWN_3, c);
        (&gPlayerStatusForCamera[c->cameraID])->unk1C[1] = 0;
    }
    if ((&gPlayerStatusForCamera[c->cameraID])->unk1C[1] == 8) {
        set_camera_shake_2(SHAKE_2_UNKNOWN_2, c);
        (&gPlayerStatusForCamera[c->cameraID])->unk1C[1] = 0;
    }

    yaw = sFirstPersonCameraYaw[c->cameraID] + 0x2000;
    if ((o = gSecondCameraFocus[c->cameraID]) != NULL) {
        object_pos_to_vec3f(secondFocus, o);
        heldState = o->oHeldState;
    } else {
        secondFocus[0] = c->xFocus;
        secondFocus[1] = (&gPlayerStatusForCamera[c->cameraID])->pos[1];
        secondFocus[2] = c->zFocus;
        heldState = 0;
    }

    focusDistance = calc_abs_dist((&gPlayerStatusForCamera[c->cameraID])->pos, secondFocus) * 1.6f;
    ...
    if (heldState == 1) {
        set_pos_from_face_angle_and_vec3f(secondFocus, (&gPlayerStatusForCamera[c->cameraID])->pos,
                                          sp2C, (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    }

    focus[0] = ((&gPlayerStatusForCamera[c->cameraID])->pos[0] + secondFocus[0]) / 2.f;
    focus[1] = ((&gPlayerStatusForCamera[c->cameraID])->pos[1] + secondFocus[1]) / 2.f + 125.f;
    focus[2] = ((&gPlayerStatusForCamera[c->cameraID])->pos[2] + secondFocus[2]) / 2.f;
    ...
    if (sCSideButtonYaw[c->cameraID] < 0) {
        sFirstPersonCameraYaw[c->cameraID] += 0x200;
        if ((sCSideButtonYaw[c->cameraID] += 0x100) > 0) {
            sCSideButtonYaw[c->cameraID] = 0;
        }
    }
    if (sCSideButtonYaw[c->cameraID] > 0) {
        sFirstPersonCameraYaw[c->cameraID] -= 0x200;
    ...
    focus[1] = ((&gPlayerStatusForCamera[c->cameraID])->pos[1] + secondFocus[1]) / 2.f + 100.f;
    if (heldState == 1) {
        focus[1] += 300.f
                    * sins((gMarioStates[c->cameraID].angleVel[1] > 0.f)
                               ? gMarioStates[c->cameraID].angleVel[1]
                               : -gMarioStates[c->cameraID].angleVel[1]);
    }
    ...
    vec3f_set_dist_and_angle(pos, pos, D_8033B3EE[c->cameraID], D_8033B3F0[c->cameraID] + 0x1000, yaw);
...
void update_fixed_camera(struct LevelCamera *c) {
    ...
    if (gCurrLevelNum == LEVEL_BBH) {
        set_fov_function(7, c);
    } else {
        set_fov_function(4, c);
    }
    c->storedYaw = return_fixed_camera_yaw(c, c->focus, c->pos);
    // c->storedYaw = atan2s(-gMarioStates[c->cameraID].pos[2]+ c->pos[2],
    // -gMarioStates[c->cameraID].pos[0]+ c->pos[0]);
    c->trueYaw = c->storedYaw;
    func_8027FF44(c);
    vec3f_set(sFixedPresetBasePositionOffset[c->cameraID], 0.f, 0.f, 0.f);
}
...
s32 return_behind_mario_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    ...
    s16 sp40;
    s16 yaw;
    s16 sp3C = -(&gPlayerStatusForCamera[c->cameraID])->faceAngle[0];
    s16 sp3A = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + 32768;
    s16 sp38 = 0;
    s16 sp36;
    s16 sp34 = 32;
    UNUSED u8 unused[12];
    ...
    if (gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_ACTIVE) {
        sp24 = 350.f;
        sp20 = 120.f;
    }
    if (!((&gPlayerStatusForCamera[c->cameraID])->action
    ...
    if (sCSideButtonYaw[c->cameraID] != 0) {
        camera_approach_s16_symmetric_bool(&sCSideButtonYaw[c->cameraID], 0, 1);
        sp36 = 8;
    }
    if (D_8033B3FA[c->cameraID] != 0) {
        sp3C = 0;
        camera_approach_s16_symmetric_bool(&D_8033B3FA[c->cameraID], 0, 1);
        sp34 = 2048;
    }

    if (D_8033B3FA[c->cameraID] == 28) {
        if (sCSideButtonYaw[c->cameraID] < 5 || sCSideButtonYaw[c->cameraID] > 28) {
            play_sound_cbutton_up();
        }
    }
    if (sCSideButtonYaw[c->cameraID] == 28) {
        if (D_8033B3FA[c->cameraID] < 5 || D_8033B3FA[c->cameraID] > 28) {
            play_sound_cbutton_up();
        }
    }

    if (gCButtonsPressed[c->cameraID] & 2) {
        if (c->controller->buttonPressed & L_CBUTTONS) {
            play_sound_cbutton_side();
        }
        if (sp48 < sp24) {
        ...
        sp38 = -16376;
        sCSideButtonYaw[c->cameraID] = 30;
        sp36 = 2;
    }
    if (gCButtonsPressed[c->cameraID] & 1) {
        if (c->controller->buttonPressed & R_CBUTTONS) {
            play_sound_cbutton_side();
        }
        if (sp48 < sp24) {
    ...
    if (gCButtonsPressed[c->cameraID] & 4) {
        if (c->controller->buttonPressed & (U_CBUTTONS | D_CBUTTONS)) {
            play_sound_cbutton_side();
        }
        if (sp48 < sp24) {
            camera_approach_f32_symmetric_bool(&sp48, sp24, 5.f);
        ...
        sp3C = -12288;
        D_8033B3FA[c->cameraID] = 30;
        sp34 = 2048;
    }
    if (gCButtonsPressed[c->cameraID] & 8) {
        if (c->controller->buttonPressed & (U_CBUTTONS | D_CBUTTONS)) {
            play_sound_cbutton_side();
        }
        if (sp48 < sp24) {
...
s32 return_behind_mario_water_camera_yaw(struct LevelCamera *c) {
    struct MarioState *marioState = &gMarioStates[c->cameraID];
    struct Surface *floor;
    Vec3f newPos;
    Vec3f oldPos;
    f32 waterHeight;
    ...
    if (c->pos[1] <= waterHeight) {
        gCameraMovementFlags[c->cameraID] |= CAM_MOVE_SUBMERGED;
    } else {
        gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_SUBMERGED;
    }
...
s16 return_slide_camera_yaw(struct LevelCamera *c) {
    ...
    s16 camPitch;
    s16 camYaw;
    UNUSED struct MarioState *marioState = &gMarioStates[c->cameraID];
    s16 goalPitch = 0x1555;
    s16 goalYaw = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + 0x8000;

    if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_CCM_SLIDE_SHORTCUT) {
        D_8033B3EE[c->cameraID] = approach_f32(D_8033B3EE[c->cameraID], -600.f, 20.f, 20.f);
    } else {
        D_8033B3EE[c->cameraID] = approach_f32(D_8033B3EE[c->cameraID], 0.f, 20.f, 20.f);
    }

    play_camera_buzz_if_cbutton(c);
    vec3f_copy(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    c->focus[1] += 50.f;
    vec3f_get_dist_and_angle(c->focus, c->pos, &distCamToFocus, &camPitch, &camYaw);
    ...
    if ((&gPlayerStatusForCamera[c->cameraID])->action != ACT_RIDING_HOOT
        && sGeometryForMario[c->cameraID].currFloorType == SURFACE_DEATH_PLANE) {
        vec3f_set_dist_and_angle(c->focus, pos, distToFocusOffset + D_8033B3EE[c->cameraID], camPitch,
                                 camYaw);
        c->pos[0] = pos[0];
        c->pos[2] = pos[2];
        ...
        pitchScale = (distCamToFocus - distToFocusOffset + D_8033B3EE[c->cameraID]) / 10000.f;
        if (pitchScale > 1.f) {
            pitchScale = 1.f;
        }
        ...
        vec3f_set_dist_and_angle(c->focus, c->pos, distToFocusOffset + D_8033B3EE[c->cameraID],
                                 camPitch, camYaw);
        gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNKNOWN_1;
        floorHeight = find_floor(c->pos[0], c->pos[1] + 200.f, c->pos[2], &floor) + 125.f;
        if (c->pos[1] < floorHeight) {
            c->pos[1] = floorHeight;
        }
        vec3f_get_dist_and_angle(c->focus, c->pos, &distCamToFocus, &camPitch, &camYaw);
        if (distCamToFocus > distToFocusOffset + D_8033B3EE[c->cameraID]) {
            distCamToFocus = distToFocusOffset + D_8033B3EE[c->cameraID];
            vec3f_set_dist_and_angle(c->focus, c->pos, distCamToFocus, camPitch, camYaw);
        }
    }
...
s32 return_mario_yaw(UNUSED struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    s16 yaw = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + sFirstPersonCameraYaw[c->cameraID]
              + 0x8000;
    set_cam_focus_and_pos_rel_mario(focus, pos, 125.f, 125.f, gCameraZoomDist[c->cameraID], 0x05B0,
                                    yaw);

    return (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1];
}
...
s16 return_close_or_free_roam_cam_yaw(struct LevelCamera *c) {
    ...
    s16 sp70;
    s16 yaw;
    s16 sp6C = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + 32768;
    f32 sp68;
    f32 sp64;
    f32 sp60;
    s16 sp5E;
    ...
    s32 sp48 = 0;
    s32 sp44 = 0;
    f32 ceilHeight = find_ceil(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][0],
                               gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1],
                               gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][2], &ceil);
    s16 sp3E;

    handle_c_button_movement(c);
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, &distFocusToCam,
                             &sp70, &yaw);

    if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_ZOOMED_OUT) {
        if (test_or_set_mario_cam_active(0, c) == CAM_ANGLE_LAKITU_MARIO) {
            zoomDist = gCameraZoomDist[c->cameraID] + 1050;
        } else {
            zoomDist = gCameraZoomDist[c->cameraID] + 400;
        }
    } else {
        zoomDist = gCameraZoomDist[c->cameraID];
    }

    if (((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_HANGING)
        || (&gPlayerStatusForCamera[c->cameraID])->action == ACT_RIDING_HOOT) {
        zoomDist *= 0.8f;
        set_spline_values(3, c);
    }

    if (D_8033B3F4[c->cameraID] == 0.f) {
        ...
        if ((D_8033B3F4[c->cameraID] -= 30.f) < 0.f) {
            D_8033B3F4[c->cameraID] = 0.f;
        }
        if (distFocusToCam > zoomDist) {
    ...
    if (sCSideButtonYaw[c->cameraID] == 0) {
        ...
        if ((c->controller->stickX != 0.f || c->controller->stickY != 0.f) != 0) {
            sp52 = 32;
        }
    } else {
        if (sCSideButtonYaw[c->cameraID] < 0) {
        ...
        camera_approach_s16_symmetric_bool(&sCSideButtonYaw[c->cameraID], 0, 256);
        sp52 = 0;
    }
    D_8032CFD4[c->cameraID] = 1024;
    sp58 = calc_hor_dist((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos);

    if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_BEHIND_MARIO_POST_DOOR) {
        if (sp58 >= 250) {
            gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_BEHIND_MARIO_POST_DOOR;
        }
        if (ABS(((&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] - yaw) / 2) < 0x1800) {
            gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_BEHIND_MARIO_POST_DOOR;
            yaw = sCameraYawAfterDoorCutscene[c->cameraID] + 32768;
        ...
        if (sCSideButtonYaw[c->cameraID] == 0) {
            sp52 = 4096;
            D_8032CFD4[c->cameraID] = 0;
            vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos,
                                     &distFocusToCam, &sp70, &yaw);
        }
        sp44 |= 1;
    }

    if (-16 < c->controller->stickY) {
        c->trueYaw = yaw;
    }
    ...
    if (sp48 == 3) {
        sCameraYawVelocity[c->cameraID] = yaw;
        gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNKNOWN_9;
        vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, spB0, &sp58, &sp5E,
                                 &sp5C);
        approach_s16_exponential_bool(&yaw, sp72, 10);
        vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, spB0, sp58, sp5E, sp5C);
        sCameraYawVelocity[c->cameraID] = (sCameraYawVelocity[c->cameraID] - yaw) / 256;
    } else {
        if (gMarioStates[c->cameraID].forwardVel == 0.f) {
            if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_UNKNOWN_9) {
                if ((sp6C - yaw) / 256 >= 0) {
                    sp3E = -1;
                } else {
                    sp3E = 1;
                }
                if ((sCameraYawVelocity[c->cameraID] > 0 && sp3E > 0)
                    || (sCameraYawVelocity[c->cameraID] < 0 && sp3E < 0)) {
                    sp50 = sp52;
                }
            } else {
                sp50 = sp52;
    ...
    if (sp48 == 0 && !(gCameraFlags2[c->cameraID] & CAM_FLAG_2_UNKNOWN_9)) {
        approach_f32_exponential_bool(&distFocusToCam, zoomDist - 100.f, 0.05f);
    }
    vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, spB0, distFocusToCam, sp70,
                             yaw);
    spB0[1] += sp68 + 125.f;
    if (find_and_return_count_wall_collisions(spB0, 10.f, 80.f) != 0) {
        gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNKNOWN_9;
    }
    c->focus[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0];
    c->focus[1] = (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 125.f + sp64;
    c->focus[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2];
    sp88 = 125.f + sGeometryForMario[c->cameraID].currFloorHeight;
    marioFloor = sGeometryForMario[c->cameraID].currFloor;
    sp90 = find_floor(spB0[0], spB0[1] + 50.f, spB0[2], &sp9C) + 125.f;
    for (sp4C = 0.1f; sp4C < 1.f; sp4C += 0.2f) {
        scale_along_line(spBC, spB0, (&gPlayerStatusForCamera[c->cameraID])->pos, sp4C);
    ...
    if (sp78 != -11000.f) {
        sp78 += 125.f;
        sp60 = sp78 - sp88;
        if (!(gCameraMovementFlags[c->cameraID] & CAM_MOVE_UNKNOWN_6)) {
            if (sp60 > 800.f
                && ((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_METAL_WATER)) {
                gCameraMovementFlags[c->cameraID] |= CAM_MOVE_UNKNOWN_6;
            }
        } else {
            if (sp60 < 400.f
                || !((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_METAL_WATER)) {
        ...
        if (!(gCameraMovementFlags[c->cameraID] & CAM_MOVE_UNKNOWN_6) && sp90 < sp78) {
            sp90 = sp78;
        }
    } else {
        gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_UNKNOWN_6;
    ...
    if ((gCameraMovementFlags[c->cameraID] & CAM_MOVE_ZOOMED_OUT)
        && (gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_ACTIVE)) {
        sp68 = 610.f;
    ...
    if (((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_HANGING)
        || (&gPlayerStatusForCamera[c->cameraID])->action == ACT_RIDING_HOOT) {
        sp90 = (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 400.f;
        if (c->currPreset == CAMERA_PRESET_FREE_ROAM) {
            sp90 -= 100.f;
        }
        ceilHeight = 20000.f;
    ...
    if ((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_ON_POLE) {
        sp90 = gMarioStates[c->cameraID].usedObj->oPosY + 125.f;
        if ((&gPlayerStatusForCamera[c->cameraID])->pos[1] - 100.f > sp90) {
            sp90 = (&gPlayerStatusForCamera[c->cameraID])->pos[1] - 100.f;
        }
        ceilHeight = 20000.f;
        vec3f_copy(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    }
    ...
    c->pos[0] = spB0[0];
    c->pos[2] = spB0[2];
    spB0[0] = gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][0];
    spB0[1] = c->pos[1];
    spB0[2] = gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][2];
    ...
    if (ceilHeight != 20000.f) {
        if (c->pos[1] > (ceilHeight -= 150.f)
            && (sp48 = func_8028A0D4(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, ceil, 0, -1))
                   == 1) {
            c->pos[1] = ceilHeight;
        }
    }
...
s32 return_spiral_stairs_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    ...
    handle_c_button_movement(c);
    vec3f_set(sFixedPresetBasePosition[c->cameraID], -1280.f, 614.f, 1740.f);
    return_height_above_floor(&sp2C, 1.f, 200.f, &sp2C, 0.9f, 200.f);
    focus[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0];
    sp24 = (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 125.f + sp2C;
    focus[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2];
    vec3f_copy(sp44, pos);
    vec3f_get_dist_and_angle(sFixedPresetBasePosition[c->cameraID], focus, &sp30, &sp5A, &sp58);
    vec3f_get_dist_and_angle(sFixedPresetBasePosition[c->cameraID], sp44, &sp30, &sp56, &sp54);
    D_8033B404[c->cameraID] = sp54 - sp58;
    if (D_8033B404[c->cameraID] < -0x4000) {
        D_8033B404[c->cameraID] = -0x4000;
    }
    if (D_8033B404[c->cameraID] > 0x4000) {
        D_8033B404[c->cameraID] = 0x4000;
    }
    sp58 += D_8033B404[c->cameraID];
    sp54 = sp58;
    camera_approach_s16_symmetric_bool(&sp54, sp58, 4096);
    vec3f_set_dist_and_angle(sFixedPresetBasePosition[c->cameraID], sp44, 300.f, 0, sp54);
    ...
    if (sp28 != -11000.f) {
        if (sp28 < sGeometryForMario[c->cameraID].currFloorHeight) {
            sp28 = sGeometryForMario[c->cameraID].currFloorHeight;
        }
...
s32 return_slide_or_0f_camera_yaw(UNUSED struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    s16 sp2E = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + sFirstPersonCameraYaw[c->cameraID]
               + 32768;
...
static void unused_update_mode_0f_camera(struct LevelCamera *c) {
    if (c->controller->buttonPressed & U_CBUTTONS) {
        gCameraMovementFlags[c->cameraID] |= CAM_MOVE_C_UP_MODE;
    }
    c->storedYaw = return_slide_camera_yaw(c);
}

void update_slide_camera(struct LevelCamera *c) {
    if (sGeometryForMario[c->cameraID].currFloorType == SURFACE_CLOSE_CAMERA
        || sGeometryForMario[c->cameraID].currFloorType == SURFACE_NO_CAM_COL_SLIPPERY) {
...
void func_80284CBC(struct LevelCamera *c) {
    vec3f_copy(D_8033B498[c->cameraID].pos, c->pos);
    vec3f_sub(D_8033B498[c->cameraID].pos, (&gPlayerStatusForCamera[c->cameraID])->pos);
    vec3f_set(D_8033B498[c->cameraID].focus, 0.f,
              c->focus[1] - (&gPlayerStatusForCamera[c->cameraID])->pos[1], 0.f);
}

s32 func_80284D44(struct LevelCamera *c) {
    if (!(gCameraMovementFlags[c->cameraID] & CAM_MOVE_C_UP_MODE)) {
        gCameraMovementFlags[c->cameraID] |= CAM_MOVE_C_UP_MODE;
        func_80284CBC(c);
        gCameraFlags1[c->cameraID] &= ~CAM_FLAG_1_UNKNOWN_0;
        return 1;
    }
    return 0;
}
...
s32 exit_c_up_mode(struct LevelCamera *c) {
    ...
    if ((gCameraMovementFlags[c->cameraID] & CAM_MOVE_C_UP_MODE)
        && !(gCameraMovementFlags[c->cameraID] & CAM_MOVE_UNKNOWN_10)) {
        vec3f_copy(sp30, D_8033B498[c->cameraID].pos);
        vec3f_add(sp30, (&gPlayerStatusForCamera[c->cameraID])->pos);
        vec3f_copy(sp24, D_8033B498[c->cameraID].focus);
        vec3f_add(sp24, (&gPlayerStatusForCamera[c->cameraID])->pos);
        vec3f_copy(sp68, c->focus);
        sp68[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0];
        sp68[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2];
        vec3f_get_dist_and_angle(sp68, c->pos, &sp48, &sp42, &sp40);
        vec3f_copy(sp5C, c->pos);
        sp48 = 80.f;
        if (D_8033B418[c->cameraID].unk2 == CAMERA_PRESET_SPIRAL_STAIRS
            || D_8033B418[c->cameraID].unk2 == CAMERA_PRESET_CLOSE
            || D_8033B418[c->cameraID].unk2 == CAMERA_PRESET_FREE_ROAM) {
            sp58 = 1;
            for (i = 0; i < 16 && sp58 == 1; i++) {
                ...
                if (f32_find_wall_collision(&sp5C[0], &sp5C[1], &sp5C[2], 20.f, 50.f) == 0) {
                    for (sp44 = sp48; sp44 < gCameraZoomDist[c->cameraID]; sp44 += 20.f) {
                    ...
                    if (sp44 >= gCameraZoomDist[c->cameraID]) {
                        sp58 = 0;
                    }
                }
                if (sp58 == 1) {
            ...
            if (sp58 == 0) {
                vec3f_set_dist_and_angle(sp68, D_8033B498[c->cameraID].pos,
                                         gCameraZoomDist[c->cameraID], 0, sp40 + sp3E);
                vec3f_copy(D_8033B498[c->cameraID].focus, sp68);
                vec3f_sub(D_8033B498[c->cameraID].pos, (&gPlayerStatusForCamera[c->cameraID])->pos);
                vec3f_sub(D_8033B498[c->cameraID].focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
            }
            gCameraMovementFlags[c->cameraID] |= CAM_MOVE_UNKNOWN_10;
            init_transitional_movement(c, 15);
        } else {
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_UNKNOWN_10 | CAM_MOVE_C_UP_MODE);
...
s32 return_first_person_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    s16 pitch = sFirstPersonCameraPitch[c->cameraID];
    s16 yaw = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + sFirstPersonCameraYaw[c->cameraID]
              + 32768;
...
void operate_c_up_looking(struct LevelCamera *c) {
    UNUSED s16 pitch = sFirstPersonCameraPitch[c->cameraID];
    UNUSED s16 yaw = sFirstPersonCameraYaw[c->cameraID];

    sFirstPersonCameraPitch[c->cameraID] += (s16)(c->controller->stickY * 10.f);
    sFirstPersonCameraYaw[c->cameraID] -= (s16)(c->controller->stickX * 10.f);

    if (sFirstPersonCameraPitch[c->cameraID] > 14563) {
        sFirstPersonCameraPitch[c->cameraID] = 14563;
    }
    if (sFirstPersonCameraPitch[c->cameraID] < -8192) {
        sFirstPersonCameraPitch[c->cameraID] = -8192;
    }
    if (sFirstPersonCameraYaw[c->cameraID] > 21845) {
        sFirstPersonCameraYaw[c->cameraID] = 21845;
    }
    if (sFirstPersonCameraYaw[c->cameraID] < -21845) {
        sFirstPersonCameraYaw[c->cameraID] = -21845;
    }
    ...
    (&gPlayerStatusForCamera[c->cameraID])->unk16[0] = sFirstPersonCameraPitch[c->cameraID] * 3 / 4;
    (&gPlayerStatusForCamera[c->cameraID])->unk16[1] = sFirstPersonCameraYaw[c->cameraID] * 3 / 4;
}

void func_8028547C(struct LevelCamera *c) {
    struct Struct8033B418_sub *sp2C = &D_8033B418[c->cameraID].unk8;
    struct Struct8033B418_sub *sp28 = &D_8033B418[c->cameraID].unk28;
    f32 sp24 = sp28->unk18 - sp2C->unk18;
    s16 sp22 = sp28->unk1C - sp2C->unk1C;
    s16 sp20 = sp28->unk1E - sp2C->unk1E;

    sp24 = sp2C->unk18 + sp24 * D_8033B418[c->cameraID].unk6 / D_8033B418[c->cameraID].unk4;
    sp22 = sp2C->unk1C + sp22 * D_8033B418[c->cameraID].unk6 / D_8033B418[c->cameraID].unk4;
    sp20 = sp2C->unk1E + sp20 * D_8033B418[c->cameraID].unk6 / D_8033B418[c->cameraID].unk4;
    c->focus[0] =
        sp2C->unk0[0]
        + (sp28->unk0[0] - sp2C->unk0[0]) * D_8033B418[c->cameraID].unk6 / D_8033B418[c->cameraID].unk4;
    c->focus[1] =
        sp2C->unk0[1]
        + (sp28->unk0[1] - sp2C->unk0[1]) * D_8033B418[c->cameraID].unk6 / D_8033B418[c->cameraID].unk4;
    c->focus[2] =
        sp2C->unk0[2]
        + (sp28->unk0[2] - sp2C->unk0[2]) * D_8033B418[c->cameraID].unk6 / D_8033B418[c->cameraID].unk4;
    vec3f_add(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    vec3f_set_dist_and_angle(c->focus, c->pos, sp24, sp22, sp20);
    (&gPlayerStatusForCamera[c->cameraID])->unk16[0] = 0;
    (&gPlayerStatusForCamera[c->cameraID])->unk16[1] = 0;
    if (++D_8033B418[c->cameraID].unk6 == D_8033B418[c->cameraID].unk4) {
        gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_INTO_C_UP;
    }
}
...
s32 update_c_up_camera(struct LevelCamera *c) {
    ...
    if (!(gCameraFlags1[c->cameraID] & CAM_FLAG_1_UNKNOWN_0)) {
        play_sound_cbutton_up();
        gCameraFlags1[c->cameraID] |= CAM_FLAG_1_UNKNOWN_0;
    }
    if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_INTO_C_UP) {
    ...
    if (!(gCameraMovementFlags[c->cameraID] & CAM_MOVE_UNKNOWN_10)) {
        operate_c_up_looking(c);
        return_first_person_camera_yaw(c, c->focus, c->pos);
    } else {
        if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_UNKNOWN_11) {
            vec3f_copy(c->pos, D_8033B498[c->cameraID].pos);
            vec3f_add(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos);
            vec3f_copy(c->focus, D_8033B498[c->cameraID].focus);
            vec3f_add(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
            camera_approach_s16_symmetric_bool(&(&gPlayerStatusForCamera[c->cameraID])->unk16[0], 0,
                                               1024);
            camera_approach_s16_symmetric_bool(&(&gPlayerStatusForCamera[c->cameraID])->unk16[1], 0,
                                               1024);
        } else {
            gCameraMovementFlags[c->cameraID] &= ~(CAM_MOVE_UNKNOWN_10 | CAM_MOVE_C_UP_MODE);
        }
    }
    D_8033B40C[c->cameraID] = 0.f;
    if (c->controller->buttonPressed & (A_BUTTON | B_BUTTON | D_CBUTTONS | L_CBUTTONS | R_CBUTTONS)) {
        exit_c_up_mode(c);
    }
    return 0;
}

s32 return_cannon_camera_yaw(struct LevelCamera *c, Vec3f focus, Vec3f pos) {
    set_cam_focus_and_pos_rel_mario(pos, focus, 125.f + D_8033B410[c->cameraID], 125.f, 800.f,
                                    (&gPlayerStatusForCamera[c->cameraID])->faceAngle[0],
                                    (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1]);
    return (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1];
}
...
void update_cannon_camera(struct LevelCamera *c) {
    ...
    D_8033B3F0[c->cameraID] = 0;
    gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_INTO_C_UP;
    c->storedYaw = return_cannon_camera_yaw(c, c->focus, c->pos);
    if (c->controller->buttonPressed & A_BUTTON) {
        func_80285BD8(c, 3, 1);
        D_8033B40C[c->cameraID] = 0;
        D_8033B410[c->cameraID] = 0;
        gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_UNKNOWN_1;
    } else {
        D_8033B410[c->cameraID] = approach_f32(D_8033B410[c->cameraID], 0.f, 100.f, 100.f);
    }
}

void init_transitional_movement(struct LevelCamera *c, s16 timerLength) {
    if (!(gCameraFlags2[c->cameraID] & CAM_FLAG_2_FRAME_AFTER_CAM_INIT)) {
        gCameraFlags2[c->cameraID] |= (CAM_FLAG_2_UNKNOWN_10 | CAM_FLAG_2_UNKNOWN_11);
        sCameraTransition[c->cameraID].timer = timerLength;
    }
}
...
void set_camera_preset(struct LevelCamera *c, s16 newPreset, s16 transitionTimer) {
    if (c->currPreset != newPreset) {
        D_8033B418[c->cameraID].unk0 = (newPreset != -1) ? newPreset : D_8033B418[c->cameraID].unk2;
        D_8033B418[c->cameraID].unk2 = c->currPreset;
        c->currPreset = D_8033B418[c->cameraID].unk0;
        gCameraMovementFlags[c->cameraID] &= 0xFF02;
        if (!(gCameraFlags2[c->cameraID] & CAM_FLAG_2_FRAME_AFTER_CAM_INIT)) {
            init_transitional_movement(c, transitionTimer);
            sFirstPersonCameraPitch[c->cameraID] = 0;
            sFirstPersonCameraYaw[c->cameraID] = 0;
            D_8033B3EE[c->cameraID] = 0;
            D_8033B3F0[c->cameraID] = 0;
            D_8033B3EC[c->cameraID] = 0;
            D_8033B40C[c->cameraID] = 0.f;
            D_8033B410[c->cameraID] = 0.f;
        }
    }
}

void func_80285BD8(struct LevelCamera *a, s16 b, s16 c) {
    struct Struct8033B418_sub *sp24 = &D_8033B418[a->cameraID].unk8;
    struct Struct8033B418_sub *sp20 = &D_8033B418[a->cameraID].unk28;

    if (b == 8 && gCurrLevelArea == AREA_TTM_OUTSIDE) {
    } else {
        gCameraMovementFlags[a->cameraID] &= 0xFF02;
        // gCameraMovementFlags[a->cameraID] |= CAM_MOVE_INTO_C_UP;            //TAKING THIS OUT FIXES
        // THE C UP BUG
        if (b == 0) {
            b = 4;
        }
        sFirstPersonCameraPitch[a->cameraID] = 0;
        sFirstPersonCameraYaw[a->cameraID] = 0;
        D_8033B3EE[a->cameraID] = 0;
        D_8033B3F0[a->cameraID] = 0;
        D_8033B3EC[a->cameraID] = 0;
        D_8033B418[a->cameraID].unk0 = (b != -1) ? b : D_8033B418[a->cameraID].unk2;
        D_8033B418[a->cameraID].unk2 = a->currPreset;
        D_8033B418[a->cameraID].unk4 = c;
        D_8033B418[a->cameraID].unk6 = 1;
        a->currPreset = D_8033B418[a->cameraID].unk0;
        gCameraStatus[a->cameraID].modeActive = a->currPreset;
        vec3f_copy(sp20->unk0, a->focus);
        vec3f_sub(sp20->unk0, (&gPlayerStatusForCamera[a->cameraID])->pos);
        vec3f_copy(sp20->unkC, a->pos);
        vec3f_sub(sp20->unkC, (&gPlayerStatusForCamera[a->cameraID])->pos);
        sYawFocToMario[a->cameraID] =
            TableCameraTransitions[D_8033B418[a->cameraID].unk0](a, sp20->unk0, sp20->unkC);
        vec3f_sub(sp20->unk0, (&gPlayerStatusForCamera[a->cameraID])->pos);
        vec3f_sub(sp20->unkC, (&gPlayerStatusForCamera[a->cameraID])->pos);
        vec3f_copy(sp24->unk0, gCameraStatus[a->cameraID].camFocAndPosCurrAndGoal[0]);
        vec3f_sub(sp24->unk0, (&gPlayerStatusForCamera[a->cameraID])->pos);
        vec3f_copy(sp24->unkC, gCameraStatus[a->cameraID].camFocAndPosCurrAndGoal[1]);
        vec3f_sub(sp24->unkC, (&gPlayerStatusForCamera[a->cameraID])->pos);
...
void func_80285E70(struct LevelCamera *c) {
    ...
    s16 sp32;
    UNUSED u8 unused2[8];
    if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_PAUSE_SCREEN) {
    } else {
        if (c->cutscene) {
        }
        if (1) {
            sp32 = func_8028C824(sp50, sp44, c->pos, c->focus, sCameraPosition[c->cameraID],
                                 sCameraFocus[c->cameraID], c->storedYaw, c);
            set_or_approach_s16_symmetric(&c->trueYaw, sp32, D_8032CFD4[c->cameraID], c);
            gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_UNUSED_CUTSCENE_ACTIVE;
        } else {
            //! dead code
            vec3f_copy(sp50, c->pos);
            vec3f_copy(sp44, c->focus);
        }
        vec3f_copy(sCameraPosition[c->cameraID], sp50);
        vec3f_copy(sCameraFocus[c->cameraID], sp44);
        gCameraStatus[c->cameraID].trueYaw = c->trueYaw;
        gCameraStatus[c->cameraID].storedYaw = c->storedYaw;
        vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3], c->pos);
        vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[2], c->focus);
        set_or_approach_vec3f_exponential(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[1], sp50,
                                          gCameraStatus[c->cameraID].unkAC,
                                          gCameraStatus[c->cameraID].unkB0,
                                          gCameraStatus[c->cameraID].unkAC, c);
        set_or_approach_vec3f_exponential(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[0], sp44,
                                          gCameraStatus[c->cameraID].unkA4,
                                          gCameraStatus[c->cameraID].unkA8,
                                          gCameraStatus[c->cameraID].unkA4, c);
        set_or_approach_f32_exponential(&gCameraStatus[c->cameraID].unkA4, 0.8f, 0.05f, c);
        set_or_approach_f32_exponential(&gCameraStatus[c->cameraID].unkA8, 0.3f, 0.05f, c);
        set_or_approach_f32_exponential(&gCameraStatus[c->cameraID].unkAC, 0.3f, 0.05f, c);
        set_or_approach_f32_exponential(&gCameraStatus[c->cameraID].unkB0, 0.3f, 0.05f, c);
        if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_UNKNOWN_1) {
            gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_UNKNOWN_1;
        } else {
            gCameraFlags2[c->cameraID] |= CAM_FLAG_2_SMOOTH_MOVEMENT;
        }
        // debug point
        // debugstub();
        vec3f_copy(gCameraStatus[c->cameraID].pos,
                   gCameraStatus[c->cameraID]
                       .camFocAndPosCurrAndGoal[1]); // this makes the game crash, somehow unless is et
                                                     // both to 0 but then it doesnt render well either
        vec3f_copy(gCameraStatus[c->cameraID].focus,
                   gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[0]); // seems to be zero for p2

        if (c->cutscene) {
            vec3f_add(gCameraStatus[c->cameraID].focus, D_8033B218[c->cameraID]);
            vec3f_set(D_8033B218[c->cameraID], 0, 0, 0);
        }

        vec3f_get_dist_and_angle(gCameraStatus[c->cameraID].pos, gCameraStatus[c->cameraID].focus,
                                 &gCameraStatus[c->cameraID].focusDistance,
                                 &gCameraStatus[c->cameraID].pitch, &gCameraStatus[c->cameraID].yaw);

        gCameraStatus[c->cameraID].roll = 0;

        shake_camera_pitch(gCameraStatus[c->cameraID].pos, gCameraStatus[c->cameraID].focus);
        shake_camera_yaw(gCameraStatus[c->cameraID].pos, gCameraStatus[c->cameraID].focus);
        shake_camera_roll(&gCameraStatus[c->cameraID].roll);

        set_face_angle_from_spline(gCameraStatus[c->cameraID].pos, gCameraStatus[c->cameraID].focus, c);

        if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_DIVE
            && gCameraStatus[c->cameraID].lastFrameAction != ACT_DIVE) {
            set_camera_shake(SHAKE_HIT_FROM_BELOW, c);
        }

        gCameraStatus[c->cameraID].roll += sCameraCutsceneRollOffset[c->cameraID];
        gCameraStatus[c->cameraID].roll += gCameraStatus[c->cameraID].cameraKeyCutsceneRollOffset;

        if (c->currPreset != CAMERA_PRESET_C_UP_LOOK && c->cutscene == 0) {
            gCheckingSurfaceCollisionsForCamera = 1;
            sp34 =
                find_floor(gCameraStatus[c->cameraID].pos[0], gCameraStatus[c->cameraID].pos[1] + 20.0f,
                           gCameraStatus[c->cameraID].pos[2], &floor);
            if (sp34 != -11000.f) {
                if (gCameraStatus[c->cameraID].pos[1] < (sp34 += 100.0f)) {
                    gCameraStatus[c->cameraID].pos[1] = sp34;
                } else {
                    gCheckingSurfaceCollisionsForCamera = 0;
                }
            }
        }
        vec3f_copy(sCameraTransition[c->cameraID].marioPos,
                   (&gPlayerStatusForCamera[c->cameraID])->pos);
    }
    clamp_pitch(gCameraStatus[c->cameraID].pos, gCameraStatus[c->cameraID].focus, 15872, -15872);
    gCameraStatus[c->cameraID].modeActive = c->currPreset;
    gCameraStatus[c->cameraID].modeDefault = c->defPreset;
}
...
void update_camera(struct LevelCamera *c) {
    ...
    if (c->cutscene == 0) {
        if (select_or_activate_mario_cam(0, c) == CAM_ANGLE_LAKITU_MARIO) {
            if (c->controller->buttonPressed & R_TRIG) {
                if (test_or_set_mario_cam_active(0, c) == CAM_ANGLE_LAKITU_FIXED) {
                    test_or_set_mario_cam_active(1, c);
                } else {
                    test_or_set_mario_cam_active(2, c);
                }
            }
        }
        func_8028B36C(c);
    ...
    gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_FRAME_AFTER_CAM_INIT;
    if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_INIT_CAMERA) {
        init_camera(c);
        gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_INIT_CAMERA;
        gCameraFlags2[c->cameraID] |= CAM_FLAG_2_FRAME_AFTER_CAM_INIT;
    }

    sGeometryForMario[c->cameraID].prevFloorHeight = sGeometryForMario[c->cameraID].currFloorHeight;
    sGeometryForMario[c->cameraID].prevCeilHeight = sGeometryForMario[c->cameraID].currCeilHeight;
    sGeometryForMario[c->cameraID].prevFloor = sGeometryForMario[c->cameraID].currFloor;
    sGeometryForMario[c->cameraID].prevCeil = sGeometryForMario[c->cameraID].currCeil;
    sGeometryForMario[c->cameraID].prevFloorType = sGeometryForMario[c->cameraID].currFloorType;
    sGeometryForMario[c->cameraID].prevCeilType = sGeometryForMario[c->cameraID].currCeilType;
    ...
    c->storedYaw = gCameraStatus[c->cameraID].storedYaw;
    c->currPreset = gCameraStatus[c->cameraID].modeActive;
    ...
    if (c->cutscene != 0) {
        D_8032CFD4[c->cameraID] = 0;
        handle_cutscenes(c);
        sCutsceneTransitionTimer[c->cameraID] = 0;
    } else {
        if (gCutsceneNumber[c->cameraID] != 0 && sCutsceneTransitionTimer[c->cameraID] < 8) {
            sCutsceneTransitionTimer[c->cameraID]++;
            if (sCutsceneTransitionTimer[c->cameraID] >= 8) {
                gCutsceneNumber[c->cameraID] = 0;
                sCutsceneTransitionTimer[c->cameraID] = 0;
            }
        }
    }
    ...
    if (gCurrLevelNum != LEVEL_CASTLE) {
        if ((c->cutscene == 0 && (c->controller->buttonDown & R_TRIG)
             && select_or_activate_mario_cam(0, c) == CAM_ANGLE_LAKITU_FIXED)
            || (gCameraMovementFlags[c->cameraID] & CAM_MOVE_UNKNOWN_7)
            || ((&gPlayerStatusForCamera[c->cameraID])->action) == ACT_GETTING_BLOWN) {
            if (c->cutscene == 0 && (c->controller->buttonPressed & R_TRIG)
                && select_or_activate_mario_cam(0, c) == CAM_ANGLE_LAKITU_FIXED) {
                gCameraFlags1[c->cameraID] |= CAM_FLAG_1_UNKNOWN_5;
                play_sound_rbutton_changed();
            }
            gCameraStatus[c->cameraID].unkAC = 0.f;
            gCameraStatus[c->cameraID].unkB0 = 0.f;
            c->storedYaw =
                calculate_yaw(gCameraStatus[c->cameraID].focus, gCameraStatus[c->cameraID].pos);
            c->trueYaw = c->storedYaw;
            gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_UNKNOWN_7;
        } else {
            if (gCameraFlags1[c->cameraID] & CAM_FLAG_1_UNKNOWN_5) {
                play_sound_rbutton_changed();
                gCameraFlags1[c->cameraID] &= ~CAM_FLAG_1_UNKNOWN_5;
            }
        }
...
void reset_camera(struct LevelCamera *c) {
    UNUSED s32 sp34 = 0;
    UNUSED u8 unused[16];
    UNUSED struct Struct8033B418_sub *sp20 = &D_8033B418[c->cameraID].unk8;
    UNUSED struct Struct8033B418_sub *sp1C = &D_8033B418[c->cameraID].unk28;

    gCurrLevelCamera = c;
    gCameraMovementFlags[c->cameraID] = 0;
    sCameraSideCFlags[c->cameraID] = 0;
    gCameraFlags2[c->cameraID] = 0;
    gCutsceneTimer[c->cameraID] = 0;
    D_8033B6EA[c->cameraID] = 0;
    sCutscenePhase[c->cameraID] = 0;
    gCutsceneActive[c->cameraID] = FALSE;
    gCutsceneFocus[c->cameraID] = NULL;
    gSecondCameraFocus[c->cameraID] = NULL;
    gCButtonsPressed[c->cameraID] = 0;
    vec3f_copy(sCameraTransition[c->cameraID].marioPos, (&gPlayerStatusForCamera[c->cameraID])->pos);
    sCameraTransition[c->cameraID].timer = 0;
    gCameraMovementFlags[c->cameraID] = 0;
    gCameraMovementFlags[c->cameraID] |= CAM_MOVE_INIT_CAMERA;
    gCameraFlags2[c->cameraID] = 0;
    gCameraFlags1[c->cameraID] = 0;
    sFirstPersonCameraPitch[c->cameraID] = 0;
    sFirstPersonCameraYaw[c->cameraID] = 0;
    D_8033B404[c->cameraID] = 0;
    D_8033B3EE[c->cameraID] = 0;
    D_8033B3F0[c->cameraID] = 0;
    sYawFocToMario[c->cameraID] = 0;
    D_8033B3EC[c->cameraID] = 0.f;
    D_8033B40C[c->cameraID] = 0.f;
    D_8033B410[c->cameraID] = 0.f;
    D_8033B3F4[c->cameraID] = 0.f;
    D_8033B3FC[c->cameraID] = 0.f;
    D_8033B3FA[c->cameraID] = 0;
    sCSideButtonYaw[c->cameraID] = 0;
    sPlatformLevelPresetBaseYaw[c->cameraID] = 0;
    gPlatformLevelYawOffset[c->cameraID] = 0;
    c->unk64 = 0;
    (&gPlayerStatusForCamera[c->cameraID])->unk16[0] = 0;
    (&gPlayerStatusForCamera[c->cameraID])->unk16[1] = 0;
    ...
    (&gPlayerStatusForCamera[c->cameraID])->unk1C[1] = 0;
    (&gPlayerStatusForCamera[c->cameraID])->usedObj = NULL;
    gCameraStatus[c->cameraID].shakeMagnitude[0] = 0;
    gCameraStatus[c->cameraID].shakeMagnitude[1] = 0;
    gCameraStatus[c->cameraID].shakeMagnitude[2] = 0;
    gCameraStatus[c->cameraID].unk6C[0] = 0;
    gCameraStatus[c->cameraID].unk6C[1] = 0;
    gCameraStatus[c->cameraID].unk6C[2] = 0;
    gCameraStatus[c->cameraID].unk60[0] = 0.f;
    gCameraStatus[c->cameraID].unk60[1] = 0.f;
    gCameraStatus[c->cameraID].unk60[2] = 0.f;
    gCameraStatus[c->cameraID].lastFrameAction = 0;
    set_fov_function(2, c);
    D_8033B230[c->cameraID].fieldOfView = 35.f;
    D_8033B230[c->cameraID].unk8 = 0.f;
    D_8033B230[c->cameraID].unkC = 0;
    D_8033B230[c->cameraID].unk10 = 0.f;
    D_8033B230[c->cameraID].unk14 = 0;
    sTempCutsceneNumber[c->cameraID] = 0;
    gCutsceneNumber[c->cameraID] = 0;
}
...
void init_camera(struct LevelCamera *c) {
    ...
    sCreditsCameraPitch[c->cameraID] = 0;
    sCreditsCameraYaw[c->cameraID] = 0;
    gPrevLevel = gCurrLevelArea / 16;
    gCurrLevelArea = gCurrLevelNum * 16 + gCurrentArea->index;
    gCameraModeFlags[c->cameraID] &= CAM_MODE_MARIO_SELECTED;
    gFramesPaused = 0;
    gCameraStatus[c->cameraID].modeActive = c->currPreset;
    gCameraStatus[c->cameraID].modeDefault = c->defPreset;
    gCameraStatus[c->cameraID].unkAC = 0.3f;
    gCameraStatus[c->cameraID].unkB0 = 0.3f;
    gCameraStatus[c->cameraID].unkA4 = 0.8f;
    gCameraStatus[c->cameraID].unkA4 = 0.3f; // @bug set unkA4 back-to-back
    gCameraStatus[c->cameraID].roll = 0;
    gCameraStatus[c->cameraID].cameraKeyCutsceneRollOffset = 0;
    gCameraStatus[c->cameraID].unkBC = 0;
    gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
    vec3f_set(sFixedPresetBasePositionOffset[c->cameraID], 0.f, 0.f, 0.f);
    vec3f_set(D_8033B218[c->cameraID], 0.f, 0.f, 0.f);
    find_mario_relative_geometry(&sGeometryForMario[c->cameraID], c);
    sGeometryForMario[c->cameraID].prevFloorHeight = sGeometryForMario[c->cameraID].currFloorHeight;
    sGeometryForMario[c->cameraID].prevCeilHeight = sGeometryForMario[c->cameraID].currCeilHeight;
    sGeometryForMario[c->cameraID].prevFloor = sGeometryForMario[c->cameraID].currFloor;
    ...
    sGeometryForMario[c->cameraID].prevCeilType = sGeometryForMario[c->cameraID].currCeilType;
    for (i = 0; i < 32; i++) {
        D_8033B4E0[c->cameraID][i].unk0 = -1;
        D_8033B5E0[c->cameraID][i].unk0 = -1;
    }
    D_8033B6E0[c->cameraID] = 0;
    D_8033B6E4[c->cameraID] = 0.f;
    D_8033B6E8[c->cameraID] = 0;
    sSplinePositionLimit[c->cameraID] = 0.f;
    sPositionAlongSpline[c->cameraID] = 0.f;
    sSplineParameterMax[c->cameraID] = 0;
    for (i = 0; i < 4; i++) {
        sSplineParameters[i][c->cameraID].unk0 = -1;
    }
    sCameraCutscenePitchOffset[c->cameraID] = 0;
    sCameraCutsceneYawOffset[c->cameraID] = 0;
    sCameraCutsceneRollOffset[c->cameraID] = 0;
    c->cutscene = 0;
    ...
    switch (gCurrLevelNum) {
        case LEVEL_CASTLE_GROUNDS:
            if (is_within_100_units_of_mario(-1328.f, 260.f, 4664.f, c) != 1) {
                relativePosition[0] = -400.f;
                relativePosition[2] = -800.f;
            }
            if (is_within_100_units_of_mario(-6901.f, 2376.f, -6509.f, c) == 1) {
                set_camera_cutscene_table(c, CUTSCENE_EXIT_WATERFALL);
            }
            if (is_within_100_units_of_mario(5408.f, 4500.f, 3637.f, c) == 1) {
                set_camera_cutscene_table(c, CUTSCENE_EXIT_FALL_WMOTR);
            }
            gCameraStatus[c->cameraID].modeActive = 16;
            break;
        case LEVEL_SA:
        ...
        case LEVEL_CASTLE_COURTYARD:
            ...
            break;
        case LEVEL_LLL:
            gCameraMovementFlags[c->cameraID] |= CAM_MOVE_ZOOMED_OUT;
            break;
        case LEVEL_CASTLE:
            relativePosition[2] = 150.f;
            break;
        case LEVEL_RR:
            vec3f_set(sFixedPresetBasePosition[c->cameraID], -2985.f, 478.f, -5568.f);
            break;
    }
    ...
    switch (gCurrLevelArea) {
        ...
        case AREA_SL_OUTSIDE:
            if (is_within_100_units_of_mario(257.f, 2150.f, 1399.f, c) == 1) {
                relativePosition[2] = -300.f;
            }
            break;
        ...
        case AREA_TTM_OUTSIDE:
            gCameraStatus[c->cameraID].modeActive = CAMERA_PRESET_OPEN_CAMERA;
            break;
    }
    set_pos_from_face_angle_and_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos,
                                      relativePosition,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    if (c->currPreset != CAMERA_PRESET_BEHIND_MARIO) {
        c->pos[1] = find_floor((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                               (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 100.f,
                               (&gPlayerStatusForCamera[c->cameraID])->pos[2], &floor)
                    + 125.f;
    }
    vec3f_copy(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[1], c->pos);
    vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[0], c->focus);
    vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3], c->pos);
    vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[2], c->focus);
    vec3f_copy(gCameraStatus[c->cameraID].pos, c->pos);
    vec3f_copy(gCameraStatus[c->cameraID].focus, c->focus);
    if (c->currPreset == CAMERA_PRESET_FIXED_REF_POINT) {
        set_fixed_cam_axis_sa_lobby(c->currPreset, c);
    }
    func_80284CBC(c);
    gCameraStatus[c->cameraID].trueYaw = calculate_yaw(c->focus, c->pos);
    gCameraStatus[c->cameraID].storedYaw = gCameraStatus[c->cameraID].trueYaw;
    c->trueYaw = gCameraStatus[c->cameraID].trueYaw;
    c->storedYaw = gCameraStatus[c->cameraID].trueYaw;
}

extern u8 D_8032E910[20];

void func_80287404(struct GraphNodeCamera *a) { // its alright i guess
    UNUSED u8 unused1[8];
    f32 sp34;
    s16 sp32;
    s16 sp30;
    ...
    if (gCameraMovementFlags[gCurrLevelCamera->cameraID] & CAM_MOVE_PAUSE_SCREEN) {
        if (gFramesPaused >= 2) {
            if (D_8032E910[sp28] & sp24) {
                a->to[0] = gCurrLevelCamera->xFocus;
                a->to[1] = ((&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos[1]
                            + gCurrLevelCamera->unk68)
                           / 2.f;
                a->to[2] = gCurrLevelCamera->zFocus;
                vec3f_get_dist_and_angle(a->to,
                                         (&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos,
                                         &sp34, &sp32, &sp30);
                vec3f_set_dist_and_angle((&gPlayerStatusForCamera[gCurrLevelCamera->cameraID])->pos,
                                         a->from, 6000.f, 4096, sp30);
...
void select_mario_cam_mode(void) {
    gCameraModeFlags[0] = CAM_MODE_MARIO_SELECTED;
    gCameraModeFlags[1] = CAM_MODE_MARIO_SELECTED;
}

void func_802875F8(struct GraphNodeCamera *a, struct AllocOnlyPool *b) { // this is fine i guess
...
void func_802876D0(struct GraphNodeCamera *a) { // this is fine i guess
    UNUSED u8 unused[8];
...
s32 geo_camera_preset_and_pos(s32 a, struct GraphNodeCamera *b, struct AllocOnlyPool *c) { // very fine
...
#ifdef VERSION_EU
    if (c->cutscene == CUTSCENE_INTRO_PEACH) {
        sp30 += sp30 * 0.19f;
    }
    if (c->cutscene == CUTSCENE_CREDITS) {
        sp30 += sp30 * 0.15f;
    }
    if (c->cutscene == CUTSCENE_PEACH_END) {
        sp30 += sp30 * 0.1f;
    }
#endif
    if (1 <= (*d += sp30)) {
...
s32 select_or_activate_mario_cam(s32 angle, struct LevelCamera *c) {
    s32 sp1C = 2;

    if (angle == CAM_ANGLE_LAKITU_MARIO) {
        if (!(gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_SELECTED)) {
            gCameraModeFlags[c->cameraID] |= CAM_MODE_MARIO_SELECTED;
        }
        gCameraFlags1[c->cameraID] |= CAM_FLAG_1_UNUSED_3;
    }
    if (angle == CAM_ANGLE_LAKITU_FIXED && (gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_SELECTED)) {
        test_or_set_mario_cam_active(2, c);
        gCameraModeFlags[c->cameraID] &= ~CAM_MODE_MARIO_SELECTED;
        gCameraFlags1[c->cameraID] |= CAM_FLAG_1_UNUSED_4;
    }
    if (gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_SELECTED) {
        sp1C = 1;
    }
...
s32 test_or_set_mario_cam_active(s32 a, struct LevelCamera *c) {
    s32 sp4 = 2;

    if (a == 1 && !(gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_ACTIVE)) {
        gCameraModeFlags[c->cameraID] |= CAM_MODE_MARIO_ACTIVE;
        if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_ZOOMED_OUT) {
            gCameraModeFlags[c->cameraID] |= CAM_MODE_LAKITU_WAS_ZOOMED_OUT;
            gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_ZOOMED_OUT;
        }
        gCameraFlags1[c->cameraID] |= CAM_FLAG_1_UNKNOWN_1;
    }
    if (a == 2 && (gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_ACTIVE)) {
        gCameraModeFlags[c->cameraID] &= ~CAM_MODE_MARIO_ACTIVE;
        if (gCameraModeFlags[c->cameraID] & CAM_MODE_LAKITU_WAS_ZOOMED_OUT) {
            gCameraModeFlags[c->cameraID] &= ~CAM_MODE_LAKITU_WAS_ZOOMED_OUT;
            gCameraMovementFlags[c->cameraID] |= CAM_MOVE_ZOOMED_OUT;
        } else {
            gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_ZOOMED_OUT;
        }
        gCameraFlags1[c->cameraID] |= CAM_FLAG_1_UNKNOWN_2;
    }
    if (gCameraModeFlags[c->cameraID] & CAM_MODE_MARIO_ACTIVE) {
        sp4 = 1;
    }
...
void set_spline_values(u8 a, struct LevelCamera *c) {
    switch (a) {
        case 1:
            sSplineParameterMax[c->cameraID] = 1536;
            sSplinePositionLimit[c->cameraID] = 0.04f;
            break;
        case 6:
            sSplineParameterMax[c->cameraID] = 768;
            sSplinePositionLimit[c->cameraID] = 0.06f;
            break;
        case 4:
            sSplineParameterMax[c->cameraID] = 4096;
            sSplinePositionLimit[c->cameraID] = 0.1f;
            break;
        case 2:
            sSplineParameterMax[c->cameraID] = 1536;
            sSplinePositionLimit[c->cameraID] = 0.07f;
            break;
        case 3:
            sSplineParameterMax[c->cameraID] = 1536;
            sSplinePositionLimit[c->cameraID] = 0.07f;
            break;
        case 5:
            sSplineParameterMax[c->cameraID] = 1024;
            sSplinePositionLimit[c->cameraID] = 0.07f;
            break;
        default:
            sSplineParameterMax[c->cameraID] = 0;
...
void set_face_angle_from_spline(Vec3f pos, Vec3f focus, struct LevelCamera *c) {
    s32 i;
    ...
    if (sSplineParameterMax[c->cameraID] == 0) {
        vec3f_set(faceAngleOffsetGoal, 0.f, 0.f, 0.f);
    } else {
        for (i = 0; i < 4; i++) {
            splineParameters[i][0] = sSplineParameters[i][c->cameraID].myUnion.unk8[0];
            splineParameters[i][1] = sSplineParameters[i][c->cameraID].myUnion.unk8[1];
            splineParameters[i][2] = sSplineParameters[i][c->cameraID].myUnion.unk8[2];
        }
        evaluate_cubic_spline(sPositionAlongSpline[c->cameraID], faceAngleOffsetGoal,
                              splineParameters[0], splineParameters[1], splineParameters[2],
                              splineParameters[3]);
        if (1.f <= (sPositionAlongSpline[c->cameraID] += sSplinePositionLimit[c->cameraID])) {
            for (i = 0; i < 3; i++) {
                vec3s_copy(sSplineParameters[i][c->cameraID].myUnion.unk8,
                           sSplineParameters[i + 1][c->cameraID].myUnion.unk8);
            }
            random_vec3s(sSplineParameters[3][c->cameraID].myUnion.unk8,
                         sSplineParameterMax[c->cameraID], sSplineParameterMax[c->cameraID],
                         sSplineParameterMax[c->cameraID] / 2);
            sPositionAlongSpline[c->cameraID] -= 1.f;

            // Code dead, this is set to be 0 before it is used.
            sSplinePositionLimit[c->cameraID] = RandomFloat() * 0.5f;
            if (sSplinePositionLimit[c->cameraID] < 0.02f) {
                sSplinePositionLimit[c->cameraID] = 0.02f;
            }
        }
    }

    approach_s16_exponential_bool(&sCameraCutscenePitchOffset[c->cameraID], faceAngleOffsetGoal[0],
                                  0x08);
    approach_s16_exponential_bool(&sCameraCutsceneYawOffset[c->cameraID], faceAngleOffsetGoal[1], 0x08);
    approach_s16_exponential_bool(&sCameraCutsceneRollOffset[c->cameraID], faceAngleOffsetGoal[2],
                                  0x08);

    if (sCameraCutscenePitchOffset[c->cameraID] | sCameraCutsceneYawOffset[c->cameraID]) {
        vec3f_get_dist_and_angle(pos, focus, &dist, &pitch, &yaw);
        pitch += sCameraCutscenePitchOffset[c->cameraID];
        yaw += sCameraCutsceneYawOffset[c->cameraID];
...
s32 update_camera_status(struct LevelCamera *c) {
    ...
    if (c->cutscene != 0
        || ((c->controller->buttonDown & R_TRIG)
            && select_or_activate_mario_cam(0, c) == CAM_ANGLE_LAKITU_FIXED)) {
        status |= CAM_STATUS_FIXED;
    } else if (test_or_set_mario_cam_active(0, c) == CAM_ANGLE_LAKITU_MARIO) {
...
s32 is_within_100_units_of_mario(f32 posX, f32 posY, f32 posZ, struct LevelCamera *c) {
    s32 isCloseToMario = 0;
    Vec3f pos;

    vec3f_set(pos, posX, posY, posZ);
    if (calc_abs_dist((&gPlayerStatusForCamera[c->cameraID])->pos, pos) < 100.f) {
        isCloseToMario = 1;
    }
    return isCloseToMario;
}

s32 set_or_approach_f32_exponential(f32 *dst, f32 goal, f32 scale, struct LevelCamera *c) {
    if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_SMOOTH_MOVEMENT) {
...
void set_or_approach_vec3f_exponential(Vec3f dst, Vec3f goal, f32 xScale, f32 yScale, f32 zScale,
    ...
    set_or_approach_f32_exponential(&dst[0], goal[0], xScale, c);
    set_or_approach_f32_exponential(&dst[1], goal[1], yScale, c);
    set_or_approach_f32_exponential(&dst[2], goal[2], zScale, c);
}
...
s32 set_or_approach_s16_symmetric(s16 *value, s16 target, s16 increment, struct LevelCamera *c) {
    if (gCameraFlags2[c->cameraID] & CAM_FLAG_2_SMOOTH_MOVEMENT) {
...
s16 func_80289738(s16 a, f32 b, f32 c, f32 d, f32 e, struct LevelCamera *cam) {
    Vec3f sp3C;
    f32 sp38;
    s16 sp36;
    s16 sp34;
    ...
    s16 sp30;
    s16 sp2E = 0;
    f32 sp28 = gCameraStatus[cam->cameraID].camFocAndPosCurrAndGoal[3][0] - c;
    f32 sp24 = gCameraStatus[cam->cameraID].camFocAndPosCurrAndGoal[3][1] - d;
    f32 sp20 = gCameraStatus[cam->cameraID].camFocAndPosCurrAndGoal[3][2] - e;
    ...
    if (b > sp38) {
        ...
        sp3C[1] = d;
        sp3C[2] = e;
        vec3f_get_dist_and_angle(gCameraStatus[cam->cameraID].camFocAndPosCurrAndGoal[3], sp3C, &sp38,
                                 &sp36, &sp34);
        if (sp38 < b) {
            calculate_angles(gCameraStatus[cam->cameraID].camFocAndPosCurrAndGoal[3],
                             gCameraStatus[cam->cameraID].camFocAndPosCurrAndGoal[2], &sp32, &sp30);
            sp36 -= sp32;
            sp34 -= sp30;
            sp38 -= 2000.f;
            if (sp38 < 0.f) {
...
s32 is_mario_behind_surface(UNUSED struct LevelCamera *c, struct Surface *surf) {
    s32 behindSurface = is_behind_surface((&gPlayerStatusForCamera[c->cameraID])->pos, surf);
...
void set_camera_pitch_shake(s16 a, s16 b, s16 c, struct LevelCamera *cam) {
    if (gCameraStatus[cam->cameraID].shakeMagnitude[0] < a) {
        gCameraStatus[cam->cameraID].shakeMagnitude[0] = a;
        gCameraStatus[cam->cameraID].shakePitchMagIncrement = b;
        gCameraStatus[cam->cameraID].shakePitchIncrement = c;
    }
}

void set_camera_yaw_shake(s16 a, s16 b, s16 c, struct LevelCamera *cam) {
    if (ABS(a) > ABS(gCameraStatus[cam->cameraID].shakeMagnitude[1])) {
        gCameraStatus[cam->cameraID].shakeMagnitude[1] = a;
        gCameraStatus[cam->cameraID].shakeYawMagIncrement = b;
        gCameraStatus[cam->cameraID].shakeYawIncrement = c;
    }
}

void set_camera_roll_shake(s16 a, s16 b, s16 c, struct LevelCamera *cam) {
    if (gCameraStatus[cam->cameraID].shakeMagnitude[2] < a) {
        gCameraStatus[cam->cameraID].shakeMagnitude[2] = a;
        gCameraStatus[cam->cameraID].shakeRollMagIncrement = b;
        gCameraStatus[cam->cameraID].shakeRollIncrement = c;
    }
}

void func_8028AA80(s16 a, s16 b, s16 c, f32 d, f32 e, f32 f, f32 g) { // this is fine
    Vec3f sp2C;
    f32 sp28;
    s16 sp26;
    s16 sp24;
    ...
    sp2C[1] = f;
    sp2C[2] = g;
    vec3f_get_dist_and_angle(gCameraStatus[gMarioObject->oAnimState].camFocAndPosCurrAndGoal[3], sp2C,
                             &sp28, &sp26, &sp24);
    a = func_80289738(a, d, e, f, g, gMarioStates[gMarioObject->oAnimState].thisPlayerCamera);
    if (a != 0) {
        set_camera_pitch_shake(a, b, c, gMarioStates[gMarioObject->oAnimState].thisPlayerCamera);
    }
}
...
void shake_camera_pitch(Vec3f pos, Vec3f focus) { // this is fine
    f32 dist;
    s16 pitch;
    s16 yaw;

    if (gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[0]
        | gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[1]) {
        vec3f_get_dist_and_angle(pos, focus, &dist, &pitch, &yaw);
        pitch += gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[0]
                 * sins(gCameraStatus[gMarioObject->oAnimState].shakePitchOffset);
        vec3f_set_dist_and_angle(pos, focus, dist, pitch, yaw);
        increment_shake_offset(&gCameraStatus[gMarioObject->oAnimState].shakePitchOffset,
                               gCameraStatus[gMarioObject->oAnimState].shakePitchIncrement);
        if (camera_approach_s16_symmetric_bool(
                &gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[0], 0,
                gCameraStatus[gMarioObject->oAnimState].shakePitchMagIncrement)
            == 0) {
            gCameraStatus[gMarioObject->oAnimState].shakePitchOffset = 0;
        }
    }
}

void shake_camera_yaw(Vec3f pos, Vec3f focus) { // this is fine
    f32 dist;
    s16 pitch;
    s16 yaw;

    if (gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[1] != 0) {
        vec3f_get_dist_and_angle(pos, focus, &dist, &pitch, &yaw);
        yaw += gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[1]
               * sins(gCameraStatus[gMarioObject->oAnimState].shakeYawOffset);
        vec3f_set_dist_and_angle(pos, focus, dist, pitch, yaw);
        increment_shake_offset(&gCameraStatus[gMarioObject->oAnimState].shakeYawOffset,
                               gCameraStatus[gMarioObject->oAnimState].shakeYawIncrement);
        if (camera_approach_s16_symmetric_bool(
                &gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[1], 0,
                gCameraStatus[gMarioObject->oAnimState].shakeYawMagIncrement)
            == 0) {
            gCameraStatus[gMarioObject->oAnimState].shakeYawOffset = 0;
        }
    }
}

void shake_camera_roll(s16 *roll) { // this is fine
    UNUSED u8 unused[8];

    if (gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[2] != 0) {
        increment_shake_offset(&gCameraStatus[gMarioObject->oAnimState].shakeRollOffset,
                               gCameraStatus[gMarioObject->oAnimState].shakeRollIncrement);
        *roll += gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[2]
                 * sins(gCameraStatus[gMarioObject->oAnimState].shakeRollOffset);
        if (camera_approach_s16_symmetric_bool(
                &gCameraStatus[gMarioObject->oAnimState].shakeMagnitude[2], 0,
                gCameraStatus[gMarioObject->oAnimState].shakeRollMagIncrement)
            == 0) {
            gCameraStatus[gMarioObject->oAnimState].shakeRollOffset = 0;
        }
    }
}
...
s32 func_8028AF24(struct LevelCamera *c, s16 b) {
    s16 yawGoal = 0x2AAA;
    s16 yaw = sFirstPersonCameraYaw[c->cameraID];
    ...
    switch (gCurrLevelArea) {
        case AREA_TTC:
            focus[0] = c->xFocus;
            focus[1] = (&gPlayerStatusForCamera[c->cameraID])->pos[1];
            focus[2] = c->zFocus;
            horDistFocusToMario = calc_abs_dist(focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    ...
    sp2A = gMarioStates[c->cameraID].forwardVel / 32.f * 128.f;
    if (D_8033B3EC[c->cameraID] < 0) {
...
void play_camera_buzz_if_cdown(struct LevelCamera *c) {
    if (c->controller->buttonPressed & D_CBUTTONS) {
        play_sound_button_change_blocked();
    }
}

void play_camera_buzz_if_cbutton(struct LevelCamera *c) {
    if (gCurrLevelCamera->controller->buttonPressed & CBUTTON_MASK) {
        play_sound_button_change_blocked();
    }
}

void play_camera_buzz_if_c_sideways(struct LevelCamera *c) {
    if ((gCurrLevelCamera->controller->buttonPressed & L_CBUTTONS)
        || (gCurrLevelCamera->controller->buttonPressed & R_CBUTTONS)) {
        play_sound_button_change_blocked();
    }
}
...
void func_8028B36C(struct LevelCamera *c) {
    if (gCameraFlags1[c->cameraID] & CAM_FLAG_1_UNKNOWN_1) {
        play_sound_rbutton_changed();
    }
    if (gCameraFlags1[c->cameraID] & CAM_FLAG_1_UNKNOWN_2) {
        play_sound_rbutton_changed();
    }
    gCameraFlags1[c->cameraID] &= ~(CAM_FLAG_1_UNKNOWN_1 | CAM_FLAG_1_UNKNOWN_2);
}
...
s32 func_8028B3DC(struct LevelCamera *c, UNUSED f32 b) {
    ...
    if ((gCameraMovementFlags[c->cameraID] & CAM_MOVE_UNKNOWN_5)
        || !(gCameraMovementFlags[c->cameraID]
             & (CAM_MOVE_RETURN_TO_MIDDLE | CAM_MOVE_ROTATE_RIGHT | CAM_MOVE_ROTATE_LEFT))) {
        if (c->controller->buttonPressed & (L_CBUTTONS | R_CBUTTONS)) {
            gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_UNKNOWN_5;
        }

        if (c->controller->buttonPressed & R_CBUTTONS) {
            if (sFirstPersonCameraYaw[c->cameraID] > -0x800) {
                if (!(gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_RIGHT)) {
                    gCameraMovementFlags[c->cameraID] |= CAM_MOVE_ROTATE_RIGHT;
                }

                if (c->currPreset == CAMERA_PRESET_OPEN_CAMERA) {
                    if (sFirstPersonCameraYaw[c->cameraID] > 0x22AA) {
                        sCameraSideCFlags[c->cameraID] |= 4;
                    }

                    if (sFirstPersonCameraYaw[c->cameraID] == 0x4AAA) {
                        play_sound_button_change_blocked();
                    } else {
                        play_sound_cbutton_side();
                    }
                } else {
                    if (sFirstPersonCameraYaw[c->cameraID] == 0x2AAA) {
                        play_sound_button_change_blocked();
                    } else {
                        play_sound_cbutton_side();
                    }
        ...
        if (c->controller->buttonPressed & L_CBUTTONS) {
            if (sFirstPersonCameraYaw[c->cameraID] < 0x800) {
                if (!(gCameraMovementFlags[c->cameraID] & CAM_MOVE_ROTATE_LEFT)) {
                    gCameraMovementFlags[c->cameraID] |= CAM_MOVE_ROTATE_LEFT;
                }
                ...
                if (c->currPreset == CAMERA_PRESET_OPEN_CAMERA) {
                    ...
                    if (sFirstPersonCameraYaw[c->cameraID] == -19114) {
                        play_sound_button_change_blocked();
                    } else {
                        play_sound_cbutton_side();
                    }
                } else {
                    if (sFirstPersonCameraYaw[c->cameraID] == -10922) {
                        play_sound_button_change_blocked();
                    } else {
                        play_sound_cbutton_side();
                    }
    ...
    if (c->controller->buttonPressed & D_CBUTTONS) {
        if (gCameraMovementFlags[c->cameraID] & CAM_MOVE_ZOOMED_OUT) {
            gCameraMovementFlags[c->cameraID] |= CAM_MOVE_UNK1000;
        } else {
            gCameraMovementFlags[c->cameraID] |= CAM_MOVE_ZOOMED_OUT;
            play_sound_cbutton_down();
        }
...
s32 stop_mario(s32 a) {
    ...
    if (a == 1) {
        func_8028F834(CUTSCENE_READ_MESSAGE, gCurrLevelCamera);
    }
    if (a == 2) {
    }
    return sp1C;
...
void handle_c_button_movement(struct LevelCamera *a) {
    ...
    if (a->controller->buttonPressed & U_CBUTTONS) {
        if (a->currPreset != CAMERA_PRESET_FIXED_REF_POINT
            && (gCameraMovementFlags[a->cameraID] & CAM_MOVE_ZOOMED_OUT)) {
            gCameraMovementFlags[a->cameraID] &= ~CAM_MOVE_ZOOMED_OUT;
            play_sound_cbutton_up();
        } else {
            func_80284D44(a);
            if (D_8033B3FC[a->cameraID] > gCameraZoomDist[a->cameraID]) {
                D_8033B3F4[a->cameraID] = -gCameraZoomDist[a->cameraID];
            } else {
                D_8033B3F4[a->cameraID] = gCameraZoomDist[a->cameraID];
            }
        }
    ...
    if (a->currPreset != CAMERA_PRESET_FIXED_REF_POINT) {
        if (a->controller->buttonPressed & D_CBUTTONS) {
            if (gCameraMovementFlags[a->cameraID] & CAM_MOVE_ZOOMED_OUT) {
                gCameraMovementFlags[a->cameraID] |= CAM_MOVE_UNK1000;
                D_8033B3F4[a->cameraID] = gCameraZoomDist[a->cameraID] + 400.f;
            } else {
                gCameraMovementFlags[a->cameraID] |= CAM_MOVE_ZOOMED_OUT;
                D_8033B3F4[a->cameraID] = gCameraZoomDist[a->cameraID] + 400.f;
                play_sound_cbutton_down();
        ...
        sp1E = 4096;
        if (a->controller->buttonPressed & R_CBUTTONS) {
            if (gCameraMovementFlags[a->cameraID] & CAM_MOVE_ROTATE_LEFT) {
                gCameraMovementFlags[a->cameraID] &= ~CAM_MOVE_ROTATE_LEFT;
            } else {
                gCameraMovementFlags[a->cameraID] |= CAM_MOVE_ROTATE_RIGHT;
                if (sCSideButtonYaw[a->cameraID] == 0) {
                    play_sound_cbutton_side();
                }
                sCSideButtonYaw[a->cameraID] = -sp1E;
            }
        }
        if (a->controller->buttonPressed & L_CBUTTONS) {
            if (gCameraMovementFlags[a->cameraID] & CAM_MOVE_ROTATE_RIGHT) {
                gCameraMovementFlags[a->cameraID] &= ~CAM_MOVE_ROTATE_RIGHT;
            } else {
                gCameraMovementFlags[a->cameraID] |= CAM_MOVE_ROTATE_LEFT;
                if (sCSideButtonYaw[a->cameraID] == 0) {
...
void func_8028BA38(struct LevelCamera *a) {
    s32 i;

    for (i = 0; i < 10; i++) {
        D_8033B6F0[i][a->cameraID].unk0 = 0;
        vec3f_set(D_8033B6F0[i][a->cameraID].unk4, 0.f, 0.f, 0.f);
        vec3f_set(D_8033B6F0[i][a->cameraID].unk10, 0.f, 0.f, 0.f);
        vec3s_set(D_8033B6F0[i][a->cameraID].unk1C, 0, 0, 0);
        D_8033B6F0[i][a->cameraID].unk22 = 0;
    }
}
...
u8 return_table_door_push_or_pull(u8 pullResult, u8 pushResult, struct LevelCamera *c) {
    s16 result;

    if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_PULLING_DOOR) {
        result = pullResult;
    }
    if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_PUSHING_DOOR) {
        result = pushResult;
    }
    return result;
}
...
u8 return_cutscene_table(struct LevelCamera *c) {
    ...
    if (cutscene == 0) {
        cutscene = sTempCutsceneNumber[c->cameraID];
        sTempCutsceneNumber[c->cameraID] = 0;
        if ((&gPlayerStatusForCamera[c->cameraID])->unk1C[1] == 6) {
            switch (gCurrLevelArea) {
                case AREA_CASTLE_LOBBY:
                    if (c->currPreset == CAMERA_PRESET_SPIRAL_STAIRS
                        || c->currPreset == CAMERA_PRESET_CLOSE || c->unk64 == 2) {
                        cutscene = return_table_door_push_or_pull(CUTSCENE_DOOR_A, CUTSCENE_DOOR_B, c);
                    } else {
                        cutscene = return_table_door_push_or_pull(CUTSCENE_DOOR_0, CUTSCENE_DOOR_1, c);
                    }
                    break;
                case AREA_BBH:
                    if (c->unk64 == 1) {
        ...
        if ((&gPlayerStatusForCamera[c->cameraID])->unk1C[1] == 5) {
            cutscene = CUTSCENE_DOOR_WARP;
        }
        if ((&gPlayerStatusForCamera[c->cameraID])->unk1C[1] == 1) {
            cutscene = CUTSCENE_ENTER_CANNON;
        }
        if (SURFACE_IS_PAINTING_WARP(sGeometryForMario[c->cameraID].currFloorType)) {
            cutscene = CUTSCENE_ENTER_PAINTING;
        }
        switch ((&gPlayerStatusForCamera[c->cameraID])->action) {
            case ACT_DEATH_EXIT:
        ...
        switch ((&gPlayerStatusForCamera[c->cameraID])->unk1C[1]) {
            case 9:
...
void instant_warp_camera_update(f32 displacementX, f32 displacementY, f32 displacementZ,
                                struct MarioState *m) {
    Vec3f displacement;
    struct MarioState *marioStates = &gMarioStates[m->thisPlayerCamera->cameraID];
    struct Struct8033B418_sub *sp1C = &D_8033B418[m->thisPlayerCamera->cameraID].unk8;
    struct Struct8033B418_sub *sp28 = &D_8033B418[m->thisPlayerCamera->cameraID].unk28;
    areaWarped = 1;
    gCurrLevelArea = gCurrLevelNum * 16 + gCurrentArea->index;
    displacement[0] = displacementX;
    displacement[1] = displacementY;
    displacement[2] = displacementZ;
    vec3f_add(gCameraStatus[m->thisPlayerCamera->cameraID].camFocAndPosCurrAndGoal[1], displacement);
    vec3f_add(gCameraStatus[m->thisPlayerCamera->cameraID].camFocAndPosCurrAndGoal[0], displacement);
    vec3f_add(gCameraStatus[m->thisPlayerCamera->cameraID].camFocAndPosCurrAndGoal[3], displacement);
    vec3f_add(gCameraStatus[m->thisPlayerCamera->cameraID].camFocAndPosCurrAndGoal[2], displacement);
...
void set_focus_position(struct LevelCamera *c, f32 b, f32 heightOffset, f32 d, s16 yawOffset) {
    ...
    return_height_above_floor(&heightAboveFloor, 1.f, 200.f, &heightAboveFloor, 0.9f, 200.f);
    yaw = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + yawOffset;
    c->focus[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2] + d * coss(yaw) - b * sins(yaw);
    c->focus[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0] + d * sins(yaw) + b * coss(yaw);
    c->focus[1] = (&gPlayerStatusForCamera[c->cameraID])->pos[1] + heightOffset + heightAboveFloor;
}
...
void determine_pushing_or_pulling_door(s16 *a, struct LevelCamera *c) {
    if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_PULLING_DOOR) {
        *a = 0;
    } else {
        *a = -0x8000;
...
s16 func_8028C824(Vec3f a, Vec3f b, Vec3f c, Vec3f d, Vec3f e, Vec3f f, s16 yaw,
    ...
    s16 goalYaw;
    UNUSED u8 unused2[4];
    f32 f32Timer = sCameraTransition[cam->cameraID].timer;
    s16 s16Timer = sCameraTransition[cam->cameraID].timer;
    UNUSED s16 sp78 = 0;
    Vec3f sp6C;
    Vec3f sp60;
    Vec3f sp54;
    ...
    vec3f_copy(a, c);
    vec3f_copy(b, d);
    if (gCameraFlags2[cam->cameraID] & CAM_FLAG_2_UNKNOWN_10) {
        for (i = 0; i < 3; i++) {
            sp54[i] = e[i] + (&gPlayerStatusForCamera[cam->cameraID])->pos[i]
                      - sCameraTransition[cam->cameraID].marioPos[i];
            sp48[i] = f[i] + (&gPlayerStatusForCamera[cam->cameraID])->pos[i]
                      - sCameraTransition[cam->cameraID].marioPos[i];
        }

        vec3f_get_dist_and_angle(d, sp48, &sCameraTransition[cam->cameraID].dist2,
                                 &sCameraTransition[cam->cameraID].pitch2,
                                 &sCameraTransition[cam->cameraID].yaw2);
        vec3f_get_dist_and_angle(d, sp54, &sCameraTransition[cam->cameraID].dist1,
                                 &sCameraTransition[cam->cameraID].pitch1,
                                 &sCameraTransition[cam->cameraID].yaw1);
        gCameraFlags2[cam->cameraID] &= ~CAM_FLAG_2_UNKNOWN_10;
    }
    if (sCameraTransition[cam->cameraID].timer > 0) {
        sp78 = 1;
        vec3f_get_dist_and_angle(d, c, &goalDist, &goalPitch, &goalYaw);
        distVelocity = ABS(goalDist - sCameraTransition[cam->cameraID].dist1) / f32Timer;
        pitchVelocity = ABS(goalPitch - sCameraTransition[cam->cameraID].pitch1) / s16Timer;
        yawVelocity = ABS(goalYaw - sCameraTransition[cam->cameraID].yaw1) / s16Timer;
        camera_approach_f32_symmetric_bool(&sCameraTransition[cam->cameraID].dist1, goalDist,
                                           distVelocity);
        camera_approach_s16_symmetric_bool(&sCameraTransition[cam->cameraID].yaw1, goalYaw,
                                           yawVelocity);
        camera_approach_s16_symmetric_bool(&sCameraTransition[cam->cameraID].pitch1, goalPitch,
                                           pitchVelocity);
        vec3f_set_dist_and_angle(d, sp6C, sCameraTransition[cam->cameraID].dist1,
                                 sCameraTransition[cam->cameraID].pitch1,
                                 sCameraTransition[cam->cameraID].yaw1);

        vec3f_get_dist_and_angle(c, d, &goalDist, &goalPitch, &goalYaw);
        pitchVelocity =
            sCameraTransition[cam->cameraID].pitch2 / (s16) sCameraTransition[cam->cameraID].timer;
        yawVelocity =
            sCameraTransition[cam->cameraID].yaw2 / (s16) sCameraTransition[cam->cameraID].timer;
        distVelocity = sCameraTransition[cam->cameraID].dist2 / sCameraTransition[cam->cameraID].timer;
        camera_approach_s16_symmetric_bool(&sCameraTransition[cam->cameraID].pitch2, goalPitch,
                                           pitchVelocity);
        camera_approach_s16_symmetric_bool(&sCameraTransition[cam->cameraID].yaw2, goalYaw,
                                           yawVelocity);
        camera_approach_f32_symmetric_bool(&sCameraTransition[cam->cameraID].dist2, 0, distVelocity);
        vec3f_set_dist_and_angle(d, sp60, sCameraTransition[cam->cameraID].dist2,
                                 sCameraTransition[cam->cameraID].pitch2,
                                 sCameraTransition[cam->cameraID].yaw2);
        ...
        if (cam->cutscene != 0 || !(gCameraMovementFlags[cam->cameraID] & CAM_MOVE_C_UP_MODE)) {
        ...
        sCameraTransition[cam->cameraID].timer--;
        yaw = calculate_yaw(b, a);
    } else {
        sCameraTransition[cam->cameraID].dist1 = 0.f;
        sCameraTransition[cam->cameraID].pitch1 = 0;
        sCameraTransition[cam->cameraID].yaw1 = 0;
        gCameraFlags2[cam->cameraID] &= ~CAM_FLAG_2_UNKNOWN_11;
    }
    vec3f_copy(sCameraTransition[cam->cameraID].marioPos,
               (&gPlayerStatusForCamera[cam->cameraID])->pos);
    return yaw;
}
...
s32 set_camera_preset_fixed_ref_point(struct LevelCamera *c, s16 x, s16 y, s16 z) {
    ...
    if (sFixedPresetBasePosition[c->cameraID][0] != posX
        || sFixedPresetBasePosition[c->cameraID][1] != posY
        || sFixedPresetBasePosition[c->cameraID][2] != posZ) {
        camPosSet = TRUE;
        gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
    }
    vec3f_set(sFixedPresetBasePosition[c->cameraID], posX, posY, posZ);
    if (c->currPreset != CAMERA_PRESET_FIXED_REF_POINT) {
        gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
        c->currPreset = CAMERA_PRESET_FIXED_REF_POINT;
        vec3f_set(c->pos, sFixedPresetBasePosition[c->cameraID][0],
                  (&gPlayerStatusForCamera[c->cameraID])->pos[1],
                  sFixedPresetBasePosition[c->cameraID][2]);
    }
    return camPosSet;
}
...
void set_camera_preset_boss_fight(struct LevelCamera *c) {
    if (c->currPreset != CAMERA_PRESET_BOSS_FIGHT) {
        ...
        sFirstPersonCameraYaw[c->cameraID] = c->storedYaw - 0x2000;
    }
}

void set_camera_preset_close_cam(u8 *preset, struct LevelCamera *c) {
...
void set_camera_preset_open_camera(struct LevelCamera *c, s16 b) {
    ...
    focus[2] = c->zFocus;
    if (c->currPreset != CAMERA_PRESET_OPEN_CAMERA) {
        yaw = calculate_yaw(focus, (&gPlayerStatusForCamera[c->cameraID])->pos)
              - calculate_yaw(c->focus, c->pos) + 0x4000;
        if (yaw > 0) {
...
void parallel_tracking_init(struct LevelCamera *a, struct ParallelTrackingTable *b) {
    if (a->currPreset != CAMERA_PRESET_PARALLEL_TRACKING) {
        D_8033B470[a->cameraID] = b;
        D_8033B46C[a->cameraID] = 0;
        D_8033B478[a->cameraID].pos[0] = 0.f;
        D_8033B478[a->cameraID].pos[1] = 0.f;
        D_8033B478[a->cameraID].pos[2] = 0.f;
        a->pos[0] = (D_8033B470[a->cameraID][0].unk4[0] + D_8033B470[a->cameraID][1].unk4[0]) / 2.f;
        a->pos[1] = (D_8033B470[a->cameraID][0].unk4[1] + D_8033B470[a->cameraID][1].unk4[1]) / 2.f;
        a->pos[2] = (D_8033B470[a->cameraID][0].unk4[2] + D_8033B470[a->cameraID][1].unk4[2]) / 2.f;
        gCameraFlags2[a->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
        a->currPreset = CAMERA_PRESET_PARALLEL_TRACKING;
    }
}

void set_fixed_cam_axis_sa_lobby(UNUSED s16 preset, struct LevelCamera *c) {
    switch (gCurrLevelArea) {
        case AREA_SA:
            vec3f_set(sFixedPresetBasePosition[c->cameraID], 646.f, 143.f, -1513.f);
            break;

        case AREA_CASTLE_LOBBY:
            vec3f_set(sFixedPresetBasePosition[c->cameraID], -577.f, 143.f, 1443.f);
            break;
    }
}

void func_8028D32C(u8 *preset, struct LevelCamera *c) {
    if (((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_METAL_WATER)
        || *preset == CAMERA_PRESET_BEHIND_MARIO || *preset == CAMERA_PRESET_WATER_SURFACE) {
        gCameraFlags2[c->cameraID] |= CAM_FLAG_2_BLOCK_LEVEL_SPECIFIC_UPDATES;
    }
    ...
    if ((*preset == CAMERA_PRESET_BEHIND_MARIO
         && !((&gPlayerStatusForCamera[c->cameraID])->action
              & (ACT_FLAG_SWIMMING | ACT_FLAG_METAL_WATER)))
...
CmdRet CameraRR00(struct LevelCamera *c) {
    ...
    sPlatformLevelPresetBaseYaw[c->cameraID] = 0x4000;
}
...
CmdRet CameraRR04(struct LevelCamera *c) {
    ...
    if (c->pos[1] < 6343.f) {
        c->pos[1] = 7543.f;
        gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1] = c->pos[1];
        gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[1][1] = c->pos[1];
        gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
    }
}
...
CmdRet CameraSL00(struct LevelCamera *c) {
    ...
    sPlatformLevelPresetBaseYaw[c->cameraID] = 0x1D27;
}
...
void move_camera_through_floor_while_descending(struct LevelCamera *c, f32 height) {
    ...
    if ((sGeometryForMario[c->cameraID].currFloorHeight < height - 100.f)
        && (sGeometryForMario[c->cameraID].prevFloorHeight
            > sGeometryForMario[c->cameraID].currFloorHeight)) {
        c->pos[1] = height - 400.f;
        gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[1][1] = height - 400.f;
        gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1] = height - 400.f;
    }
}
...
CmdRet camera_change_hmc_maze_entrance(struct LevelCamera *c) {
    ...
    if (c->pos[1] > -102.f) {
        vec3f_get_dist_and_angle(c->focus, gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3], &sp20,
                                 &sp26, &sp24);
        vec3f_set_dist_and_angle(c->focus, gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3], 300.f,
                                 sp26, sp24);
        gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1] = -800.f;
#ifndef VERSION_JP
        c->pos[1] = gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1];
        gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[1][1] =
            gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1];
#endif
        gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
    }
...
CmdRet CameraSSL00(UNUSED struct LevelCamera *c) {
    func_8028F834(CUTSCENE_ENTER_PYRAMID_TOP, c);
}
...
CmdRet CameraTHI00(UNUSED struct LevelCamera *c) {
    if (sFirstPersonCameraYaw[c->cameraID] < 0x2AAA) {
        sFirstPersonCameraYaw[c->cameraID] = 0x2AAA;
    }
}

CmdRet CameraTHI01(UNUSED struct LevelCamera *c) {
    if (sFirstPersonCameraYaw[c->cameraID] > 0x3AAA) {
        sFirstPersonCameraYaw[c->cameraID] = 0x3AAA;
    }
}
...
CmdRet camera_change_hmc_cotmc_pool_entry(struct LevelCamera *c) {
    if (((&gPlayerStatusForCamera[c->cameraID])->action != ACT_SPECIAL_DEATH_EXIT)
        && ((&gPlayerStatusForCamera[c->cameraID])->action != ACT_SPECIAL_EXIT_AIRBORNE)) {
        set_camera_cutscene_table(c, CUTSCENE_ENTER_POOL);
    }
}

CmdRet CameraInside20(UNUSED struct LevelCamera *c) {
    vec3f_set(sFixedPresetBasePositionOffset[c->cameraID],
              -813.f - sFixedPresetBasePosition[c->cameraID][0],
              378.f - sFixedPresetBasePosition[c->cameraID][1],
              1103.f - sFixedPresetBasePosition[c->cameraID][2]);
}
...
CmdRet CameraInside1E(struct LevelCamera *c) {
    ...
    if ((sGeometryForMario[c->cameraID].currFloorHeight > 1229.f) && (floorHeight < 1229.f)
        && (sCSideButtonYaw[c->cameraID] == 0)) {
...
CmdRet CameraInside1F(struct LevelCamera *c) {
    ...
    if ((floorHeight > -110.f) && (sCSideButtonYaw[c->cameraID] == 0)) {
...
static CmdRet CameraUnused(struct LevelCamera *c) {
    if (c->currPreset == CAMERA_PRESET_SPIRAL_STAIRS) {
        ...
        set_camera_preset_close_cam(&c->currPreset, c);
    }
}
...
CmdRet CameraBBH2E2F(struct LevelCamera *c) {
    ...
    set_pos_from_face_angle_and_vec3f(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3],
                                      (&gPlayerStatusForCamera[c->cameraID])->pos, relativePosition,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1] = -2300.f;
    vec3f_copy(c->pos, gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3]);
    gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
}
...
CmdRet CameraBBH38(struct LevelCamera *c) {
    if (c->currPreset == CAMERA_PRESET_FIXED_REF_POINT) {
        set_camera_preset_close_cam(&c->currPreset, c);
        c->pos[1] = -405.f;
        gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3][1] = -405.f;
    }
}
...
CmdRet camera_change_activate_ccm_slide_flag(UNUSED struct LevelCamera *c) {
    gCameraFlags2[c->cameraID] |= CAM_FLAG_2_CCM_SLIDE_SHORTCUT;
}
...
u32 surface_type_presets(struct LevelCamera *c) {
    ...
    switch (sGeometryForMario[c->cameraID].currFloorType) {
...
s16 level_specific_camera_update(struct LevelCamera *c) {
    ...
    if (c->currPreset == CAMERA_PRESET_C_UP_LOOK) {
        c->currPreset = (u8) D_8033B418[c->cameraID].unk2;
    }
    func_8028D32C(&c->currPreset, c);
    if (currLevelNum > 40) {
        currLevelNum = 40;
    }
    ...
    if (TableLevelCinematicCamera[currLevelNum] != 0) {
        ...
        while ((TableLevelCinematicCamera[currLevelNum])[i].unk4 != 0) {
            if ((TableLevelCinematicCamera[currLevelNum])[i].area == area) {
                ...
                if (check_if_vector_fits_in_bounds((&gPlayerStatusForCamera[c->cameraID])->pos, sp50,
                                                   sp44,
                                                   (TableLevelCinematicCamera[currLevelNum])[i].unk14)
                    == 1) {
                    if ((gCameraFlags2[c->cameraID] & CAM_FLAG_2_BLOCK_LEVEL_SPECIFIC_UPDATES) == 0) {
    ...
    if ((gCameraFlags2[c->cameraID] & CAM_FLAG_2_BLOCK_LEVEL_SPECIFIC_UPDATES) == 0) {
        switch (gCurrLevelArea) {
            ...
            case AREA_BBH:
                if (vec3f_compare(sFixedPresetBasePosition[c->cameraID], 210.f, 420.f, 3109.f)
                    == 1) // if camera is fixed at bbh_room_13_balcony_camera (but as floats)
                {
                    if ((&gPlayerStatusForCamera[c->cameraID])->pos[1] < 1800.f) {
                        set_camera_preset(c, CAMERA_PRESET_CLOSE, 30);
                    }
                }
                break;
            ...
            case AREA_BOB:
                if (set_preset_via_surface_or_input(c, 0) == 0) {
                    if (sGeometryForMario[c->cameraID].currFloorType == SURFACE_BOSS_FIGHT_CAMERA) {
                        set_camera_preset_boss_fight(c);
                    } else {
                        if (c->currPreset == CAMERA_PRESET_CLOSE) {
            ...
            case AREA_WDW_MAIN:
                if (sGeometryForMario[c->cameraID].currFloorType == SURFACE_INSTANT_WARP_1B) {
                    if (0) {
                    }
            ...
            case AREA_WDW_TOWN:
                if (sGeometryForMario[c->cameraID].currFloorType == SURFACE_INSTANT_WARP_1C) {
                    if (0) {
                    }
            ...
            case AREA_DDD_WHIRLPOOL:
                gCameraStatus[c->cameraID].modeDefault = CAMERA_PRESET_REVERSE_TOWER;
                break;

            case AREA_DDD_SUB:
                if ((c->currPreset != CAMERA_PRESET_BEHIND_MARIO)
                    && (c->currPreset != CAMERA_PRESET_WATER_SURFACE)) {
                    if ((((&gPlayerStatusForCamera[c->cameraID])->action & ACT_FLAG_ON_POLE) != 0)
                        || (sGeometryForMario[c->cameraID].currFloorHeight > 800.f)) {
                        set_camera_preset(c, CAMERA_PRESET_PLATFORM_LEVEL, 60);

                    } else {
                        if ((&gPlayerStatusForCamera[c->cameraID])->pos[1] < 800.f) {
                            set_camera_preset(c, CAMERA_PRESET_FREE_ROAM, 60);
                        }
                    }
                }
                gCameraStatus[c->cameraID].modeDefault = CAMERA_PRESET_FREE_ROAM;
                break;
        }
    }
...
s32 func_8028F2F0(struct LevelCamera *a, Vec3f pos, s16 *c, s16 d) {
    ...
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[a->cameraID])->pos, pos, &distToMario,
                             &pitchToMario, &yawToMario);
    gCameraFlags2[a->cameraID] &= ~CAM_FLAG_2_COLLIDING_WITH_WALL;
    ...
    for (i = 0; i < 8; i++) {
        wallData.x = (&gPlayerStatusForCamera[a->cameraID])->pos[0]
                     + ((pos[0] - (&gPlayerStatusForCamera[a->cameraID])->pos[0]) * sp44);
        wallData.y = (&gPlayerStatusForCamera[a->cameraID])->pos[1]
                     + ((pos[1] - (&gPlayerStatusForCamera[a->cameraID])->pos[1]) * sp44);
        wallData.z = (&gPlayerStatusForCamera[a->cameraID])->pos[2]
                     + ((pos[2] - (&gPlayerStatusForCamera[a->cameraID])->pos[2]) * sp44);
        ...
        if (find_wall_collisions(&wallData) != 0) {
            ...
            if (find_wall_collisions(&wallData) != 0) {
                ...
                if ((func_8028A0D4((&gPlayerStatusForCamera[a->cameraID])->pos, pos, wall, d,
                                   SURFACE_WALL_MISC)
                     == 0)
...
void find_mario_relative_geometry(struct PlayerGeometry *a, struct LevelCamera *c) {
    struct Surface *surf;
    s16 tempCheckingSurfaceCollisionsForCamera = gCheckingSurfaceCollisionsForCamera;
    gCheckingSurfaceCollisionsForCamera = 1;

    if (find_floor((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                   (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 10.f,
                   (&gPlayerStatusForCamera[c->cameraID])->pos[2], &surf)
        != -11000.f) {
    ...
    if (find_ceil((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                  (&gPlayerStatusForCamera[c->cameraID])->pos[1] - 10.f,
                  (&gPlayerStatusForCamera[c->cameraID])->pos[2], &surf)
        != 20000.f) {
    ...
    gCheckingSurfaceCollisionsForCamera = 0;
    a->currFloorHeight = find_floor((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                                    (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 10.f,
                                    (&gPlayerStatusForCamera[c->cameraID])->pos[2], &a->currFloor);
    a->currCeilHeight = find_ceil((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                                  (&gPlayerStatusForCamera[c->cameraID])->pos[1] - 10.f,
                                  (&gPlayerStatusForCamera[c->cameraID])->pos[2], &a->currCeil);
    a->waterHeight = find_water_level((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                                      (&gPlayerStatusForCamera[c->cameraID])->pos[2]);
    gCheckingSurfaceCollisionsForCamera = tempCheckingSurfaceCollisionsForCamera;
}

void func_8028F800(u8 cutsceneTable, struct Object *o, struct LevelCamera *c) {

    sTempCutsceneNumber[c->cameraID] = cutsceneTable;
    gCutsceneNumber[c->cameraID] = 0;
    gCutsceneFocus[c->cameraID] = o;
    gCutsceneActive[c->cameraID] = FALSE;
}

u8 func_8028F834(u8 a, struct LevelCamera *c) {
    sTempCutsceneNumber[c->cameraID] = a;
    D_8032CFFC[c->cameraID] = 0;
    return 0;
}
...
void func_8028FABC(struct LevelCamera *c) {
    D_8033B6E0[c->cameraID] = 0;
    D_8033B6E4[c->cameraID] = 0;
}

void func_8028FAE0(struct LevelCamera *c) {
    gCutsceneTimer[c->cameraID] = 0x8000;
    c->cutscene = 0;
    vec3f_copy(c->focus, D_8033B4B8[c->cameraID].focus);
    vec3f_copy(c->pos, D_8033B4B8[c->cameraID].pos);
}
...
s16 func_8028FD94(s32 a, struct LevelCamera *c) {
    s16 timer = gCutsceneTimer[c->cameraID];
...
static CmdRet Cutscene26Todo0(UNUSED struct LevelCamera *a) {
    gCutsceneTimer[a->cameraID] = func_8028FD94(1, a);
}

static void unused_8028FE50(UNUSED struct LevelCamera *a) {
    gCutsceneTimer[a->cameraID] = func_8028FD94(2, a);
}
...
void func_8028FEDC(struct LevelCamera *a) {
    D_8033B40C[a->cameraID] = 0;
}
...
void move_credits_camera(struct LevelCamera *c, s16 minPitch, s16 maxPitch, s16 minYaw, s16 maxYaw) {
    ...
    if (sCreditsCameraPitch[c->cameraID] > maxPitch) {
        sCreditsCameraPitch[c->cameraID] = maxPitch;
    }
    if (sCreditsCameraPitch[c->cameraID] < minPitch) {
        sCreditsCameraPitch[c->cameraID] = minPitch;
    }

    if (sCreditsCameraYaw[c->cameraID] > maxYaw) {
        sCreditsCameraYaw[c->cameraID] = maxYaw;
    }
    if (sCreditsCameraYaw[c->cameraID] < minYaw) {
        sCreditsCameraYaw[c->cameraID] = minYaw;
    }

    pitch += sCreditsCameraPitch[c->cameraID];
    yaw += sCreditsCameraYaw[c->cameraID];
    vec3f_set_dist_and_angle(c->pos, D_8033B218[c->cameraID], distCamToFocus, pitch, yaw);
    vec3f_sub(D_8033B218[c->cameraID], c->focus);
}

void func_80290144(struct LevelCamera *c) {
    vec3f_copy(D_8033B4B8[c->cameraID].pos, c->pos);
    vec3f_copy(D_8033B4B8[c->cameraID].focus, c->focus);
    D_8033B4B8[c->cameraID].unk18 = D_8033B40C[c->cameraID];
    D_8033B4B8[c->cameraID].unk1C = D_8033B410[c->cameraID];
}

void func_802901B4(struct LevelCamera *c) {
    vec3f_copy(c->pos, D_8033B4B8[c->cameraID].pos);
    vec3f_copy(c->focus, D_8033B4B8[c->cameraID].focus);
    D_8033B40C[c->cameraID] = D_8033B4B8[c->cameraID].unk18;
    D_8033B410[c->cameraID] = D_8033B4B8[c->cameraID].unk1C;
}

void func_80290224(struct LevelCamera *c) {
    func_8028FEDC(c);
    vec3f_copy(D_8033B4B8[c->cameraID].pos, c->pos);
    D_8033B4B8[c->cameraID].focus[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0];
    D_8033B4B8[c->cameraID].focus[1] = c->focus[1];
    D_8033B4B8[c->cameraID].focus[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2];
}
...
CmdRet CutsceneEnterSomething8029041C(struct LevelCamera *c) {
    set_camera_shake_2(SHAKE_2_UNKNOWN_1, c);
    func_8029A494(1, c);
}
...
void func_80290514(struct LevelCamera *c) {
    gCameraFlags2[c->cameraID] |= CAM_FLAG_2_BEHIND_MARIO_POST_DOOR;
    sCameraYawAfterDoorCutscene[c->cameraID] = calculate_yaw(c->focus, c->pos);
}
...
CmdRet CutscenePeachEnd0_2(struct LevelCamera *c) {
    ...
    sp24[2] = ABS((&gPlayerStatusForCamera[c->cameraID])->pos[1] - c->pos[1]) * -0.1f;
    if (sp24[2] > -100.f) {
        sp24[2] = -100.f;
    }

    set_pos_from_face_angle_and_vec3f(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos, sp24,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
}
...
CmdRet CutscenePeachEndCommon367A(UNUSED struct LevelCamera *c) {
    D_8033B6F0[9][c->cameraID].unk4[0] = 0.f;
    func_8028FABC(c);
}

CmdRet CutscenePeachEnd3_1(struct LevelCamera *c) {
    func_80287CFC(c->pos, D_8032E040, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    func_80287CFC(c->focus, D_8032E090, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
}
...
CmdRet CutscenePeachEnd5_1(UNUSED struct LevelCamera *c) {
    func_8028FABC(c);
    D_8033B6F0[2][c->cameraID].unk4[1] = 150.f;
}

CmdRet CutscenePeachEnd5_2(struct LevelCamera *c) {
    func_80287CFC(c->pos, D_8032E0E8, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    c->pos[1] += gCutsceneFocus[c->cameraID]->oPosY + D_8033B6F0[3][c->cameraID].unk4[1];
}

CmdRet CutscenePeachEnd5_3(UNUSED struct LevelCamera *c) {
    camera_approach_f32_symmetric_bool(&(D_8033B6F0[2][c->cameraID].unk4[1]), 90.f, 0.5f);
}

CmdRet CutscenePeachEnd5_4(struct LevelCamera *c) {
    Vec3f sp1C;

    func_80287CFC(sp1C, D_8032E0E8, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    c->pos[0] = sp1C[0];
    c->pos[2] = sp1C[2];
    approach_f32_exponential_bool(&c->pos[1], (sp1C[1] += gCutsceneFocus[c->cameraID]->oPosY), 0.07f);
}
...
CmdRet CutscenePeachEnd6(struct LevelCamera *c) {
    call_cutscene_func_in_time_range(CutscenePeachEndCommon367A, c, 0, 0);
    func_80287CFC(c->pos, D_8032E188, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    func_80287CFC(c->focus, D_8032E1D0, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    move_credits_camera(c, -0x2000, 0x2000, -0x2000, 0x2000);
}

CmdRet CutscenePeachEnd7_1(UNUSED struct LevelCamera *c) {
    func_80287CFC(c->focus, D_8032E218, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
}
...
CmdRet CutscenePeachEnd7(struct LevelCamera *c) {
    ...
    func_80299C60(7, 300, c);
    func_80299C60(9, 340, c);
...
CmdRet CutscenePeachEndA_1(struct LevelCamera *c) {
    func_80287CFC(c->focus, D_8032E258, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    vec3f_set(c->pos, 699.f, 1680.f, -703.f);
}

CmdRet CutscenePeachEndA_2(UNUSED struct LevelCamera *c) {
    D_8033B230[c->cameraID].fieldOfView = 37.f;
}
...
CmdRet CutscenePeachEndA(struct LevelCamera *c) {
    ...
    func_80299C60(8, 600, c);
    func_80299C60(8, 608, c);
    func_80299C60(8, 624, c);
    func_80299C60(8, 710, c);
}

CmdRet CutscenePeachEndB(struct LevelCamera *c) {
    set_fov_function(1, c);
    c->cutscene = 0;
    gCutsceneTimer[c->cameraID] = -0x8000;
}

CmdRet CutsceneGrandStar0_1(UNUSED struct LevelCamera *c) {
    vec3f_set(D_8033B6F0[0][c->cameraID].unk4, 0.f, 150.f, -600.f);
    set_pos_from_face_angle_and_vec3f(
        D_8033B6F0[1][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos,
        D_8033B6F0[0][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    D_8033B6F0[1][c->cameraID].unk4[1] = 457.f;
}
...
CmdRet CutsceneGrandStar0_2(struct LevelCamera *c) {
    ...
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos,
                             D_8033B6F0[1][c->cameraID].unk4, &sp2C, &sp2A, &sp28);
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, &sp24, &sp22, &sp20);
    ...
    vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, sp24, sp22, sp20);
}

CmdRet CutsceneGrandStar0_4(UNUSED struct LevelCamera *c) {
    vec3s_set(D_8033B6F0[0][c->cameraID].unk1C, 0, (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1],
              0);
    vec3f_set(D_8033B6F0[2][c->cameraID].unk4, 0.f, 0.f, 0.f);
}

CmdRet CutsceneGrandStar0_5(UNUSED struct LevelCamera *c) {
    camera_approach_f32_symmetric_bool(&D_8033B6F0[2][c->cameraID].unk4[2], -40.f, 2.0f);
    D_8033B6F0[2][c->cameraID].unk4[0] = 5.0f;
}

CmdRet CutsceneGrandStar0_6(struct LevelCamera *c) {
    camera_approach_f32_symmetric_bool(&D_8033B6F0[2][c->cameraID].unk4[2], 0.f, 2.f);
    D_8033B6F0[2][c->cameraID].unk4[0] = 0.f;
    approach_f32_exponential_bool(&c->pos[0], (&gPlayerStatusForCamera[c->cameraID])->pos[0], 0.01f);
    approach_f32_exponential_bool(&c->pos[2], (&gPlayerStatusForCamera[c->cameraID])->pos[2], 0.01f);
}

CmdRet CutsceneGrandStar0_7(struct LevelCamera *c) {
    set_pos_from_face_angle_and_vec3f(c->pos, c->pos, D_8033B6F0[2][c->cameraID].unk4,
                                      D_8033B6F0[0][c->cameraID].unk1C);
}

CmdRet CutsceneGrandStar0_3(struct LevelCamera *c) {
    Vec3f sp24;

    vec3f_set(sp24, (&gPlayerStatusForCamera[c->cameraID])->pos[0],
              ((&gPlayerStatusForCamera[c->cameraID])->pos[1] - 307.f) * 0.5f + 407.f,
              (&gPlayerStatusForCamera[c->cameraID])->pos[2]);
...
CmdRet CutsceneGrandStar1_1(struct LevelCamera *c) {
    vec3f_set(D_8033B6F0[7][c->cameraID].unk4, 0.5f, 0.5f, 0.5f);
    vec3f_set(D_8033B6F0[6][c->cameraID].unk4, 0.01f, 0.01f, 0.01f);
    vec3f_set(D_8033B6F0[4][c->cameraID].unk4, 0.f, 0.f, 0.f);
    vec3f_set(D_8033B6F0[5][c->cameraID].unk4, 0.f,
              c->focus[1] - (&gPlayerStatusForCamera[c->cameraID])->pos[1], 0.f);
    D_8033B6F0[8][c->cameraID].unk4[2] = 0.f;
    D_8033B6F0[8][c->cameraID].unk4[0] = 0.f;
}
...
CmdRet CutsceneGrandStar1_2(UNUSED struct LevelCamera *c) {
    ...
    approach_vec3f_exponential(D_8033B6F0[4][c->cameraID].unk4, sp24, 0.05f, 0.05f, 0.05f);
    camera_approach_f32_symmetric_bool(&D_8033B6F0[5][c->cameraID].unk4[1], 0.f, 2.f);
    camera_approach_f32_symmetric_bool(&D_8033B6F0[5][c->cameraID].unk4[2], -200.f, 6.f);
}

CmdRet CutsceneGrandStar1_3(UNUSED struct LevelCamera *c) {
    camera_approach_f32_symmetric_bool(&D_8033B6F0[8][c->cameraID].unk4[0], 15.f, 0.1f);

    camera_approach_f32_symmetric_bool(&D_8033B6F0[4][c->cameraID].unk4[0], -2000.f,
                                       D_8033B6F0[8][c->cameraID].unk4[0]);
    camera_approach_f32_symmetric_bool(&D_8033B6F0[4][c->cameraID].unk4[1], 1200.f,
                                       D_8033B6F0[8][c->cameraID].unk4[0] / 10.f);
    camera_approach_f32_symmetric_bool(&D_8033B6F0[4][c->cameraID].unk4[2], 1000.f,
                                       D_8033B6F0[8][c->cameraID].unk4[0] / 10.f);

    camera_approach_f32_symmetric_bool(&D_8033B6F0[5][c->cameraID].unk4[0], 0.f,
                                       D_8033B6F0[8][c->cameraID].unk4[0]);
    camera_approach_f32_symmetric_bool(&D_8033B6F0[5][c->cameraID].unk4[1], 1200.f,
                                       D_8033B6F0[8][c->cameraID].unk4[0] / 2.f);
    camera_approach_f32_symmetric_bool(&D_8033B6F0[5][c->cameraID].unk4[2], 1000.f,
                                       D_8033B6F0[8][c->cameraID].unk4[0] / 1.5f);
}
...
CmdRet CutsceneGrandStar1_4(struct LevelCamera *c) {
    ...
    camera_approach_f32_symmetric_bool(&D_8033B6F0[8][c->cameraID].unk4[2], 90.f, 2.5f);
    set_pos_from_face_angle_and_vec3f(sp34, (&gPlayerStatusForCamera[c->cameraID])->pos,
                                      D_8033B6F0[4][c->cameraID].unk4,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    set_pos_from_face_angle_and_vec3f(sp28, (&gPlayerStatusForCamera[c->cameraID])->pos,
                                      D_8033B6F0[5][c->cameraID].unk4,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);

    vec3f_get_dist_and_angle(sp34, c->pos, &sp24, &sp22, &sp20);
    camera_approach_f32_symmetric_bool(&sp24, 0, D_8033B6F0[8][c->cameraID].unk4[2]);
...
void func_80291BBC(struct LevelCamera *a, f32 b, f32 c) {
    ...
    set_pos_from_face_angle_and_vec3f(sp2C, (&gPlayerStatusForCamera[a->cameraID])->pos, sp20,
                                      (&gPlayerStatusForCamera[a->cameraID])->faceAngle);
...
CmdRet CutsceneDanceCommon(struct LevelCamera *c) {
    ...
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, &sp20, &sp26, &sp24);
    approach_f32_exponential_bool(&sp20, 600.f, 0.3f);
    approach_s16_exponential_bool(&sp26, 0x1000, 0x10);
    vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, sp20, sp26, sp24);
}

CmdRet CutsceneStarDance1_4(struct LevelCamera *c) {
    rotate_and_move_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, 0, 0, 0x200);
}

CmdRet CutsceneStarDance1_5(struct LevelCamera *c) {
    rotate_and_move_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, -15.f, 0, 0);
}

CmdRet CutsceneStarDance1_6(struct LevelCamera *c) {
    rotate_and_move_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, 20.f, 0, 0);
}
...
CmdRet CutsceneStarDance1_2(struct LevelCamera *c) {
    func_80299C98(0x200, 40, -0x8000, c);
}
...
CmdRet CutsceneStarDance1(struct LevelCamera *c) {
    ...
    if (c->cutscene != CUTSCENE_STAR_DANCE_1_2) {
        ...
        if (((&gPlayerStatusForCamera[c->cameraID])->action != ACT_STAR_DANCE_NO_EXIT)
            && ((&gPlayerStatusForCamera[c->cameraID])->action != ACT_STAR_DANCE_WATER)
            && ((&gPlayerStatusForCamera[c->cameraID])->action != ACT_STAR_DANCE_EXIT)) {
            gCutsceneTimer[c->cameraID] = 0x8000;
            c->cutscene = 0;
            init_transitional_movement(c, 20);
            gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNUSED_CUTSCENE_ACTIVE;
...
CmdRet func_80291FE8(struct LevelCamera *a, s16 b, s16 c) {
    ...
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[a->cameraID])->pos, a->pos, &distCamToMario,
                             &pitch, &yaw);
    sp26 = yaw - b;
...
CmdRet CutsceneStarDance3_1(struct LevelCamera *c) {
    ...
    vec3f_copy(D_8033B6F0[9][c->cameraID].unk4, c->focus);
    D_8033B6F0[8][c->cameraID].unk1C[0] = 0x2000;
}
...
CmdRet CutsceneStarDance3_2(struct LevelCamera *c) {
    ...
    vec3f_set(sp24, (&gPlayerStatusForCamera[c->cameraID])->pos[0],
              (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 125.f,
              (&gPlayerStatusForCamera[c->cameraID])->pos[2]);
    approach_vec3f_exponential(D_8033B6F0[9][c->cameraID].unk4, sp24, 0.2f, 0.2f, 0.2f);
    vec3f_copy(c->focus, D_8033B6F0[9][c->cameraID].unk4);
}
...
CmdRet CutsceneStarDance3_3(struct LevelCamera *c) {
    ...
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, &sp28, &sp2E, &sp2C);
    ...
    vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, sp28, sp2E, sp2C);
}
...
CmdRet CutsceneStarDance3_5(UNUSED struct LevelCamera *c) {
    set_fov_function(9, c);
}

CmdRet CutsceneStarDance3_6(UNUSED struct LevelCamera *c) {
    func_80299C98(0x300, 48, -0x8000, c);
}

CmdRet CutsceneStarDance3(struct LevelCamera *c) {
    gCameraFlags2[c->cameraID] |= CAM_FLAG_2_SMOOTH_MOVEMENT;

    if ((&gPlayerStatusForCamera[c->cameraID])->action == ACT_STAR_DANCE_WATER) {
...
CmdRet CutsceneStarDance2_1(struct LevelCamera *c) {
    ...
    vec3f_copy(D_8033B6F0[9][c->cameraID].unk4, c->focus);
    D_8033B6F0[8][c->cameraID].unk4[2] = 65.f;
...
void func_80292884(struct LevelCamera *c) {
    vec3f_copy(c->focus, D_8033B6F0[9][c->cameraID].unk4);
    D_8033B6F0[9][c->cameraID].unk1C[0] -= 29;
    D_8033B6F0[9][c->cameraID].unk1C[1] += 29;
    rotate_camera(c, D_8033B6F0[9][c->cameraID].unk1C[0], D_8033B6F0[9][c->cameraID].unk1C[1]);
}

CmdRet CutsceneStarDance2_4(struct LevelCamera *c) {
    func_80292884(c);
    rotate_and_move_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos,
                          D_8033B6F0[8][c->cameraID].unk4[2], 0, 0);
}

CmdRet CutsceneStarDance2_5(struct LevelCamera *c) {
    rotate_and_move_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, 0, 0, 0x80);
}

CmdRet CutsceneStarDance2_6(UNUSED struct LevelCamera *c) {
    func_80299C98(0x400, 48, -0x8000, c);
}
...
CmdRet CutsceneStarDance2(struct LevelCamera *c) {
    ...
    set_fov_function(2, c);
    set_spline_values(5, c);
}

CmdRet CutsceneKeyDance0_6(struct LevelCamera *c) {
    set_pos_from_face_angle_and_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos,
                                      D_8033B6F0[8][c->cameraID].unk4,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    set_pos_from_face_angle_and_vec3f(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos,
                                      D_8033B6F0[7][c->cameraID].unk4,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
}

CmdRet CutsceneKeyDance0_2(struct LevelCamera *c) {
    vec3f_set(D_8033B6F0[8][c->cameraID].unk4, 38.f, 171.f, -248.f);
    vec3f_set(D_8033B6F0[7][c->cameraID].unk4, -57.f, 51.f, 187.f);
}

CmdRet CutsceneKeyDance0_3(struct LevelCamera *c) {
    vec3f_set(D_8033B6F0[8][c->cameraID].unk4, -178.f, 62.f, -132.f);
    vec3f_set(D_8033B6F0[7][c->cameraID].unk4, 299.f, 91.f, 58.f);
}

CmdRet CutsceneKeyDance0_4(struct LevelCamera *c) {
    gCameraStatus[c->cameraID].cameraKeyCutsceneRollOffset = 0x2800;
    vec3f_set(D_8033B6F0[8][c->cameraID].unk4, 89.f, 373.f, -304.f);
    vec3f_set(D_8033B6F0[7][c->cameraID].unk4, 0.f, 127.f, 0.f);
}

CmdRet CutsceneKeyDance0_5(struct LevelCamera *c) {
    gCameraStatus[c->cameraID].cameraKeyCutsceneRollOffset = 0;
    vec3f_set(D_8033B6F0[8][c->cameraID].unk4, 135.f, 158.f, -673.f);
    vec3f_set(D_8033B6F0[7][c->cameraID].unk4, -20.f, 135.f, -198.f);
}

CmdRet CutsceneKeyDance0_7(struct LevelCamera *c) {
    func_80299C98(0x180, 48, -0x8000, c);
}

CmdRet CutsceneKeyDance0_8(struct LevelCamera *c) {
    set_spline_values(1, c);
}
...
CmdRet CutsceneEnterBowserPlatform0_3(UNUSED struct LevelCamera *c) {
    gSecondCameraFocus[c->cameraID]->oBowserUnk88 = 1;
}

CmdRet CutsceneEnterBowserPlatform0_5(struct LevelCamera *c) {
    vec3f_set_dist_and_angle(D_8033B6F0[2][c->cameraID].unk4, c->pos,
                             D_8033B6F0[3][c->cameraID].unk4[2], D_8033B6F0[3][c->cameraID].unk1C[0],
                             D_8033B6F0[3][c->cameraID].unk1C[1]);
    vec3f_set(D_8033B6F0[2][c->cameraID].unk4, gSecondCameraFocus[c->cameraID]->oPosX,
              gSecondCameraFocus[c->cameraID]->oPosY, gSecondCameraFocus[c->cameraID]->oPosZ);
}

CmdRet CutsceneEnterBowserPlatform0_8(UNUSED struct LevelCamera *c) {
    f32 sp1C = 150.0f;

    sp1C = sins(D_8033B6F0[4][c->cameraID].unk1C[1]) * 120.0f + 120.0f;
    D_8033B6F0[4][c->cameraID].unk1C[1] -= 0x200;
    approach_f32_exponential_bool(&D_8033B6F0[0][c->cameraID].unk4[1], sp1C, 0.5f);
}

CmdRet CutsceneEnterBowserPlatform0_9(struct LevelCamera *c) {
    set_pos_from_face_angle_and_vec3f(c->focus, D_8033B6F0[2][c->cameraID].unk4,
                                      D_8033B6F0[0][c->cameraID].unk4,
                                      D_8033B6F0[2][c->cameraID].unk1C);
}

CmdRet CutsceneEnterBowserPlatform0_7(UNUSED struct LevelCamera *c) {
    approach_s16_exponential_bool(&D_8033B6F0[3][c->cameraID].unk1C[0], 1736, 30);
    approach_f32_exponential_bool(&D_8033B6F0[0][c->cameraID].unk4[2], -200.f, 0.02f);
    approach_f32_exponential_bool(&D_8033B6F0[3][c->cameraID].unk4[2], 550.f, 0.02f);
}

CmdRet CutsceneEnterBowserPlatform0_6(UNUSED struct LevelCamera *c) {
    approach_f32_exponential_bool(&D_8033B6F0[0][c->cameraID].unk4[2], 0.f, 0.05f);
}
...
CmdRet CutsceneEnterBowserPlatform0_2(struct LevelCamera *c) {
    D_8033B6F0[3][c->cameraID].unk4[2] = 430.f;
    D_8033B6F0[3][c->cameraID].unk1C[1] = gSecondCameraFocus[c->cameraID]->oMoveAngleYaw - 0x2000;
    D_8033B6F0[3][c->cameraID].unk1C[0] = 3472;

    vec3f_set(D_8033B6F0[0][c->cameraID].unk4, 0.f, 120.f, -800.f);
    vec3s_set(D_8033B6F0[2][c->cameraID].unk1C, gSecondCameraFocus[c->cameraID]->oMoveAnglePitch,
              gSecondCameraFocus[c->cameraID]->oMoveAngleYaw,
              gSecondCameraFocus[c->cameraID]->oMoveAngleRoll);
...
CmdRet CutsceneEnterBowserPlatform2(struct LevelCamera *c) {
    ...
    init_transitional_movement(c, 20);
    gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNUSED_CUTSCENE_ACTIVE;
    sFirstPersonCameraYaw[c->cameraID] = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + 0x4000;
    gSecondCameraFocus[c->cameraID]->oBowserUnk88 = 2;
}

CmdRet CutsceneEnterBowserPlatform0(struct LevelCamera *c) {
    func_80299C60(2, 0, c);

    if (gSecondCameraFocus[c->cameraID] != NULL) {
...
CmdRet CutsceneStarSpawn0_2(struct LevelCamera *c) {
    ...
    if (gCutsceneFocus[c->cameraID] != NULL) {
        object_pos_to_vec3f(pos, gCutsceneFocus[c->cameraID]);
        pos[1] += gCutsceneFocus[c->cameraID]->hitboxHeight;
...
CmdRet CutsceneStarSpawn0(struct LevelCamera *c) {
    ...
    if (gCutsceneActive[c->cameraID]) {
        gCutsceneTimer[c->cameraID] = 0x7FFF;
    }
}

CmdRet CutsceneStarSpawn1(struct LevelCamera *c) {
    if ((c->currPreset == CAMERA_PRESET_BOSS_FIGHT) && (test_or_set_mario_cam_active(0, c) == 2)) {
...
CmdRet Cutscene80293794(struct LevelCamera *c) {
    vec3f_copy(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    c->focus[1] =
        c->pos[1] + ((&gPlayerStatusForCamera[c->cameraID])->pos[1] + 125.f - c->pos[1]) * 0.5f;
    approach_vec3f_exponential(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos, 0.05f, 0.4f,
                               0.05f);
}
...
CmdRet CutsceneSpecialStarSpawn0_1(struct LevelCamera *c) {
    object_pos_to_vec3f(D_8033B6F0[1][c->cameraID].unk4, gCutsceneFocus[c->cameraID]);
    func_80290224(c);
    D_8033B6F0[2][c->cameraID].unk4[2] = D_8033B230[c->cameraID].fieldOfView;
}

CmdRet CutsceneSpecialStarSpawn0_3(struct LevelCamera *c) {
    approach_f32_exponential_bool(&c->focus[0], gCutsceneFocus[c->cameraID]->oPosX, 0.15f);
    approach_f32_exponential_bool(&c->focus[2], gCutsceneFocus[c->cameraID]->oPosZ, 0.15f);
}

CmdRet CutsceneSpecialStarSpawn0_4(struct LevelCamera *c) {
    approach_f32_exponential_bool(&c->focus[1], gCutsceneFocus[c->cameraID]->oPosY, 0.1f);
}

CmdRet CutsceneSpecialStarSpawn0_5(struct LevelCamera *c) {
    c->focus[1] = D_8033B6F0[1][c->cameraID].unk4[1]
                  + (gCutsceneFocus[c->cameraID]->oPosY - D_8033B6F0[1][c->cameraID].unk4[1]) * 0.8f;
}

CmdRet CutsceneSpecialStarSpawn0_2(struct LevelCamera *c) {
    f32 sp3C;
    s16 sp3A, sp38, sp36;
    struct Object *o = gCutsceneFocus[c->cameraID];

    vec3f_set(D_8033B6F0[1][c->cameraID].unk4, o->oHomeX, o->oHomeY, o->oHomeZ);
    vec3f_get_dist_and_angle(D_8033B6F0[1][c->cameraID].unk4, c->pos, &sp3C, &sp3A, &sp38);
    sp36 = calculate_yaw(D_8033B6F0[1][c->cameraID].unk4, c->pos);
    sp38 = calculate_yaw(D_8033B6F0[1][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    ...
    vec3f_set_dist_and_angle(D_8033B6F0[1][c->cameraID].unk4, c->pos, 400.f, 0x1000, sp38);
    gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
}

CmdRet CutsceneSpecialStarSpawn0_6(UNUSED struct LevelCamera *c) {
    D_8033B230[c->cameraID].fieldOfView = 60.f;
}
...
CmdRet CutsceneSpecialStarSpawn1(struct LevelCamera *c) {
    ...
    gCutsceneTimer[c->cameraID] = -0x8000;
    c->cutscene = 0;
    D_8033B230[c->cameraID].fieldOfView = D_8033B6F0[2][c->cameraID].unk4[2];
}
...
void func_80293DE8(struct LevelCamera *a, f32 b, s16 c, s16 d, s16 e) {
    ...
    vec3f_get_dist_and_angle(D_8033B6F0[3][a->cameraID].unk4, a->pos, &sp40, &sp3E, &sp3C);

    if ((sp40 > 8000.f) && (a->cutscene == CUTSCENE_PREPARE_CANNON)) {
        sp40 = b * 4.f;
        sp3E = c;
        vec3f_copy(D_8033B6F0[0][a->cameraID].unk4, D_8033B6F0[3][a->cameraID].unk4);
        gCameraFlags2[a->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;

        if (gCurrLevelNum == LEVEL_TTM) {
            sp3C = atan2s(D_8033B6F0[3][a->cameraID].unk4[2] - a->zFocus,
                          D_8033B6F0[3][a->cameraID].unk4[0] - a->xFocus);
        }
    } else {
        if (a->cutscene == CUTSCENE_PREPARE_CANNON) {
            vec3f_get_dist_and_angle(a->pos, D_8033B6F0[0][a->cameraID].unk4, &sp30, &sp2E, &sp2C);
            vec3f_get_dist_and_angle(a->pos, D_8033B6F0[3][a->cameraID].unk4, &sp38, &sp36, &sp34);
            ...
            vec3f_set_dist_and_angle(a->pos, D_8033B6F0[0][a->cameraID].unk4, sp30, sp2E, sp2C);
        } else {
            approach_vec3f_exponential(D_8033B6F0[0][a->cameraID].unk4, D_8033B6F0[3][a->cameraID].unk4,
                                       0.1f, 0.1f, 0.1f);
        }
    }
    ...
    vec3f_set_dist_and_angle(D_8033B6F0[3][a->cameraID].unk4, a->pos, sp40, sp3E, sp3C);
    vec3f_copy(a->focus, D_8033B6F0[0][a->cameraID].unk4);
    rotate_camera(a, d, e);
...
CmdRet CutscenePrepareCannon0_2(struct LevelCamera *c) {
    func_80293DE8(c, 300.f, 0x2000, 0, D_8033B6F0[5][c->cameraID].unk1C[1]);
    camera_approach_s16_symmetric_bool(&D_8033B6F0[5][c->cameraID].unk1C[1], 0x400, 17);
    set_spline_values(1, c);
}

void func_802941CC(f32 *a, f32 b, struct LevelCamera *c) {
    f32 sp24 = ABS(b - *a) / D_8033B6F0[2][c->cameraID].unk4[0];
    camera_approach_f32_symmetric_bool(a, b, sp24);
}

CmdRet CutscenePrepareCannon0_3(struct LevelCamera *c) {
    f32 sp1C = calc_abs_dist(c->pos, D_8033B4B8[c->cameraID].pos);

    if (sp1C < 8000.f) {
        func_802941CC(&c->pos[0], D_8033B4B8[c->cameraID].pos[0], c);
        func_802941CC(&c->pos[1], D_8033B4B8[c->cameraID].pos[1], c);
        func_802941CC(&c->pos[2], D_8033B4B8[c->cameraID].pos[2], c);
        func_802941CC(&c->focus[0], D_8033B4B8[c->cameraID].focus[0], c);
        func_802941CC(&c->focus[1], D_8033B4B8[c->cameraID].focus[1], c);
        func_802941CC(&c->focus[2], D_8033B4B8[c->cameraID].focus[2], c);
    } else {
        vec3f_copy(c->focus, D_8033B4B8[c->cameraID].focus);
        vec3f_copy(c->pos, D_8033B4B8[c->cameraID].pos);
        gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
    }
    if (D_8033B6F0[2][c->cameraID].unk4[0] > 1.f) {
        D_8033B6F0[2][c->cameraID].unk4[0] -= 1.f;
    }
}
...
void func_802944A8(struct LevelCamera *c) {
    ...
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, &sp24, &sp22, &sp20);
    approach_s16_exponential_bool(&sp20,
                                  ((&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] - 0x3000), 8);
    vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, sp24, sp22, sp20);
}
...
CmdRet CutsceneDeath1_1(struct LevelCamera *c) {
    vec3f_copy(D_8033B6F0[0][c->cameraID].unk4, c->focus);
    vec3f_copy(D_8033B6F0[3][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    D_8033B6F0[3][c->cameraID].unk4[1] += 70.f;
}

CmdRet CutsceneDeath1_2(struct LevelCamera *c) {
    func_80294538(c);
    set_spline_values(4, c);
}
...
CmdRet CutsceneDeath2_1(struct LevelCamera *c) {
    ...
    set_pos_from_face_angle_and_vec3f(D_8033B6F0[3][c->cameraID].unk4,
                                      (&gPlayerStatusForCamera[c->cameraID])->pos, sp1C,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    vec3f_copy(D_8033B6F0[0][c->cameraID].unk4, c->focus);
}
...
CmdRet CutsceneQuicksandDeath0(struct LevelCamera *c) {
    D_8033B6F0[3][c->cameraID].unk4[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0];
    D_8033B6F0[3][c->cameraID].unk4[1] = (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 20.f;
    D_8033B6F0[3][c->cameraID].unk4[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2];
...
CmdRet Cutscene1ATodo0_3(UNUSED struct LevelCamera *c) {
    ...
    set_pos_from_face_angle_and_vec3f(sp2C, (&gPlayerStatusForCamera[c->cameraID])->pos, sp20,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    approach_vec3f_exponential(D_8033B6F0[3][c->cameraID].unk4, sp2C, 0.1f, 0.1f, 0.1f);
}
...
CmdRet Cutscene1ATodo0_2(struct LevelCamera *c) {
    ...
    func_80293DE8(c, 400.f, 0x2800, 0x200, 0);
    sp30 = find_poison_gas_level((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                                 (&gPlayerStatusForCamera[c->cameraID])->pos[2]);
...
CmdRet CutsceneEnterPool0_1(struct LevelCamera *c) {
    ...
    if (gCurrLevelNum == LEVEL_CASTLE) { // entering HMC
        vec3f_set(D_8033B6F0[3][c->cameraID].unk4, 2485.f, -1589.f, -2659.f);
    }
    if (gCurrLevelNum == LEVEL_HMC) { // entering CotMC
        vec3f_set(D_8033B6F0[3][c->cameraID].unk4, 3350.f, -4589.f, 4800.f);
    }
...
CmdRet Cutscene26Todo1_1(struct LevelCamera *c) {
    ...
    vec3f_copy(D_8033B6F0[1][c->cameraID].unk4, c->focus);
    vec3f_set(D_8033B6F0[3][c->cameraID].unk4, c->xFocus, 1280.f, c->zFocus);
}

CmdRet Cutscene26Todo1_5(UNUSED struct LevelCamera *c) {
    set_fov_function(10, c);
}

CmdRet Cutscene26Todo1_2(struct LevelCamera *c) {
    approach_vec3f_exponential(c->focus, D_8033B6F0[3][c->cameraID].unk4, 0.02f, 0.02f, 0.02f);
    gCameraFlags2[c->cameraID] |= CAM_FLAG_2_SMOOTH_MOVEMENT;
}
...
CmdRet Cutscene26Todo1_3(struct LevelCamera *c) {
    ...
    vec3f_copy(D_8033B6F0[4][c->cameraID].unk4, c->pos);
    vec3f_copy(D_8033B6F0[5][c->cameraID].unk4, c->focus);
    vec3f_copy(c->focus, D_8033B6F0[3][c->cameraID].unk4);

    vec3f_get_dist_and_angle(D_8033B6F0[3][c->cameraID].unk4,
                             (&gPlayerStatusForCamera[c->cameraID])[0].pos, &sp20, &sp26, &sp24);
    vec3f_set_dist_and_angle(D_8033B6F0[3][c->cameraID].unk4, c->pos, 2000.f, 0, sp24);
    c->pos[1] += 500.f;
}
...
CmdRet Cutscene26Todo1_4(struct LevelCamera *c) {
    ...
    vec3f_get_dist_and_angle(D_8033B6F0[3][c->cameraID].unk4, c->pos, &sp20, &sp26, &sp24);
    approach_f32_exponential_bool(&sp20, 2000.f, 0.1f);
    vec3f_set_dist_and_angle(D_8033B6F0[3][c->cameraID].unk4, c->pos, sp20, sp26, sp24);
...
CmdRet Cutscene26Todo1_7(UNUSED struct LevelCamera *c) {
    set_camera_shake_2(8, c);
}

CmdRet Cutscene26Todo1_6(struct LevelCamera *c) {
    UNUSED u32 pad[2];

    vec3f_copy(c->pos, D_8033B6F0[4][c->cameraID].unk4);
    vec3f_copy(c->focus, D_8033B6F0[5][c->cameraID].unk4);
    set_camera_shake_2(SHAKE_2_UNKNOWN_3, c);
}
...
CmdRet CutsceneEnterPyramidTop0(struct LevelCamera *c) {
    ...
    if ((&gPlayerStatusForCamera[c->cameraID])->pos[1] > 1250.f) {
...
static void unused_8029538C(struct LevelCamera *c) {
    ...
    sp24 = calc_abs_dist(D_8033B6F0[3][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    sp24 = calc_abs_dist(D_8033B6F0[9][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos)
           + 200.f;
...
CmdRet CutsceneDialog0_1(struct LevelCamera *c) {
    ...
    D_8033B6F0[8][c->cameraID].unk1C[0] = 0;
    vec3f_copy(D_8033B6F0[8][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    D_8033B6F0[8][c->cameraID].unk4[1] += 125.f;
    object_pos_to_vec3f(D_8033B6F0[9][c->cameraID].unk4, gCutsceneFocus[c->cameraID]);
    D_8033B6F0[9][c->cameraID].unk4[1] += gCutsceneFocus[c->cameraID]->hitboxHeight + 200.f;
    D_8033B6F0[9][c->cameraID].unk1C[1] =
        calculate_yaw(D_8033B6F0[8][c->cameraID].unk4, D_8033B6F0[9][c->cameraID].unk4);

    sp18 = calculate_yaw((&gPlayerStatusForCamera[c->cameraID])->pos,
                         gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[1]);
    if ((sp18 - D_8033B6F0[9][c->cameraID].unk1C[1]) & 0x8000) {
        D_8033B6F0[9][c->cameraID].unk1C[1] -= 0x6000;
    } else {
        D_8033B6F0[9][c->cameraID].unk1C[1] += 0x6000;
    }
}
...
CmdRet CutsceneDialog0_2(struct LevelCamera *c) {
    ...
    scale_along_line(sp3C, D_8033B6F0[9][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos,
                     0.7f);
    vec3f_get_dist_and_angle(c->pos, sp3C, &sp4C, &sp4A, &sp48);
    sp4A = calculate_verticle_angle(c->pos, D_8033B6F0[9][c->cameraID].unk4);
    vec3f_set_dist_and_angle(c->pos, sp30, sp4C, sp4A, sp48);
    sp3C[1] = sp3C[1] + (D_8033B6F0[9][c->cameraID].unk4[1] - sp3C[1]) * 0.1f;
    approach_vec3f_exponential(c->focus, sp3C, 0.2f, 0.2f, 0.2f);
    vec3f_copy(sp30, c->pos);
    sp30[1] = D_8033B6F0[8][c->cameraID].unk4[1];
    vec3f_get_dist_and_angle(D_8033B6F0[8][c->cameraID].unk4, sp30, &sp4C, &sp4A, &sp48);
    approach_s16_exponential_bool(&sp48, D_8033B6F0[9][c->cameraID].unk1C[1], 0x10);
    approach_f32_exponential_bool(&sp4C, 180.f, 0.05f);
    vec3f_set_dist_and_angle(D_8033B6F0[8][c->cameraID].unk4, sp30, sp4C, sp4A, sp48);
    sp30[1] = D_8033B6F0[8][c->cameraID].unk4[1]
              + sins(calculate_verticle_angle(D_8033B6F0[9][c->cameraID].unk4,
                                              D_8033B6F0[8][c->cameraID].unk4))
                    * 100.f;
...
CmdRet CutsceneDialog0_3(struct LevelCamera *c) {
    if (c->cutscene == CUTSCENE_DIALOG_2) {
        create_dialog_box_with_response(D_8033B320[c->cameraID]);
    } else {
        create_dialog_box(D_8033B320[c->cameraID]);
    }

    D_8033B6F0[8][c->cameraID].unk1C[0] = 3;
}
...
CmdRet CutsceneDialog0(struct LevelCamera *c) {
    ...
    if (gDialogResponse != 0) {
        D_8032CFFC[c->cameraID] = gDialogResponse;
    }

    if ((get_dialog_id() == -1) && (D_8033B6F0[8][c->cameraID].unk1C[0] != 0)) {
        if (c->cutscene != CUTSCENE_DIALOG_2) {
            D_8032CFFC[c->cameraID] = 3;
        }
...
CmdRet CutsceneReadMessage0_1(struct LevelCamera *c) {
    ...
    D_8033B6F0[1][c->cameraID].unk1C[0] = sFirstPersonCameraPitch[c->cameraID];
    D_8033B6F0[1][c->cameraID].unk1C[1] = sFirstPersonCameraYaw[c->cameraID];
    sFirstPersonCameraPitch[c->cameraID] = -2096;
    sFirstPersonCameraYaw[c->cameraID] = 0;
    D_8033B6F0[0][c->cameraID].unk1C[0] = 0;
}

static void unused_80295A28(struct LevelCamera *c) {
    Vec3s sp20;

    vec3s_set(sp20, 0, (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1], 0);
    set_pos_from_face_angle_and_rel_coords(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, sp20, 0,
                                           100.f, 190.f);
    set_pos_from_face_angle_and_rel_coords(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos, sp20,
                                           0, 70.f, -20.f);
}
...
CmdRet CutsceneReadMessage0(struct LevelCamera *c) {
    ...
    switch (D_8033B6F0[0][c->cameraID].unk1C[0]) {
        case 0:
            if (get_dialog_id() != -1) {
                D_8033B6F0[0][c->cameraID].unk1C[0] += 1;
                set_time_stop_flags(TIME_STOP_ENABLED | TIME_STOP_UNKNOWN_2);
            }
            break;
        case 1:
            ...
            if (get_dialog_id() == -1) {
                ...
                gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNUSED_CUTSCENE_ACTIVE;
                clear_time_stop_flags(TIME_STOP_ENABLED | TIME_STOP_UNKNOWN_2);
                sFirstPersonCameraPitch[c->cameraID] = D_8033B6F0[1][c->cameraID].unk1C[0];
                sFirstPersonCameraYaw[c->cameraID] = D_8033B6F0[1][c->cameraID].unk1C[1];
                func_80290598(c);
            }
    }
    gCameraFlags2[c->cameraID] |= CAM_FLAG_2_UNUSED_CUTSCENE_ACTIVE;
...
CmdRet CutsceneExitSuccess1(UNUSED struct LevelCamera *c) {
    vec3f_copy(D_8033B6F0[7][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    vec3s_copy(D_8033B6F0[7][c->cameraID].unk1C, (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    vec3f_set(D_8033B6F0[6][c->cameraID].unk4, 6.f, 363.f, 543.f);
    vec3f_set(D_8033B6F0[5][c->cameraID].unk4, 137.f, 226.f, 995.f);
}
...
CmdRet CutsceneExitSuccess2(struct LevelCamera *c) {
    ...
    switch (gPrevLevel) {
        ...
        default:
            set_pos_from_face_angle_and_vec3f(c->pos, D_8033B6F0[7][c->cameraID].unk4,
                                              D_8033B6F0[5][c->cameraID].unk4,
                                              D_8033B6F0[7][c->cameraID].unk1C);
...
CmdRet CutsceneExitSuccess4(struct LevelCamera *c) {
    set_pos_from_face_angle_and_vec3f(c->focus, D_8033B6F0[7][c->cameraID].unk4,
                                      D_8033B6F0[6][c->cameraID].unk4,
                                      D_8033B6F0[7][c->cameraID].unk1C);

    if ((gPrevLevel == LEVEL_COTMC) || (gPrevLevel == LEVEL_HMC) || (gPrevLevel == LEVEL_RR)
        || (gPrevLevel == LEVEL_WMOTR)) {
        c->focus[0] = c->pos[0] + ((&gPlayerStatusForCamera[c->cameraID])->pos[0] - c->pos[0]) * 0.7f;
        c->focus[1] = c->pos[1] + ((&gPlayerStatusForCamera[c->cameraID])->pos[1] - c->pos[1]) * 0.4f;
        c->focus[2] = c->pos[2] + ((&gPlayerStatusForCamera[c->cameraID])->pos[2] - c->pos[2]) * 0.7f;
    } else {
        c->focus[1] = c->pos[1] + ((&gPlayerStatusForCamera[c->cameraID])->pos[1] - c->pos[1]) * 0.2f;
    }
}

CmdRet CutsceneExitSuccess3(UNUSED struct LevelCamera *c) {
    approach_f32_exponential_bool(&D_8033B6F0[6][c->cameraID].unk4[0], -24.f, 0.05f);
}

CmdRet CutsceneExitBowserSuccess0_1(struct LevelCamera *c) {
    if (c->cutscene == CUTSCENE_EXIT_BOWSER_SUCC) {
        set_camera_pitch_shake(0x800, 0x40, 0x800, c);
    }
}
...
CmdRet CutsceneBBHExitSuccess0_1(UNUSED struct LevelCamera *c) {
    vec3f_set(D_8033B6F0[5][c->cameraID].unk4, 137.f, 246.f, 1115.f);
}
...
CmdRet CutsceneNonPaintingDeath0_1(UNUSED struct LevelCamera *c) {
    vec3f_copy(D_8033B6F0[7][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    vec3s_copy(D_8033B6F0[7][c->cameraID].unk1C, (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    vec3f_set(D_8033B6F0[6][c->cameraID].unk4, -42.f, 350.f, 727.f);
    vec3f_set(D_8033B6F0[5][c->cameraID].unk4, 107.f, 226.f, 1187.f);
}
...
CmdRet CutsceneNonPaintingDeath0_2(UNUSED struct LevelCamera *c) {
    switch (gPrevLevel) {
        case LEVEL_HMC:
            vec3f_set(D_8033B6F0[5][c->cameraID].unk4, 187.f, 369.f, -197.f);
            break;
        case LEVEL_COTMC:
            vec3f_set(D_8033B6F0[5][c->cameraID].unk4, 187.f, 369.f, -197.f);
            break;
        default:
            vec3f_set(D_8033B6F0[5][c->cameraID].unk4, 107.f, 246.f, 1307.f);
            break;
    }
}
...
CmdRet CutsceneCapSwitchPress0_1(struct LevelCamera *c) {
    ...
    func_80290224(c);
    sp24 = calculate_yaw((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos);
    D_8033B6F0[3][c->cameraID].unk1C[1] = 0x1200;
    D_8033B6F0[1][c->cameraID].unk1C[1] =
        (sp24
         - ((&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + D_8033B6F0[3][c->cameraID].unk1C[1]))
        & 0xFF00;
}
...
CmdRet CutsceneCapSwitchPress0_4(struct LevelCamera *c) {
    f32 sp2C;
    s16 sp2A, sp28;
    UNUSED s16 sp26 = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + 0x1000;
    UNUSED s16 sp24;
    UNUSED s32 sp20 = D_8033B6F0[1][c->cameraID].unk1C[1];

    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, &sp2C, &sp2A, &sp28);

    if (D_8033B6F0[3][c->cameraID].unk1C[1] != 0x1000) {
        D_8033B6F0[3][c->cameraID].unk1C[1] += 0x100;
    }
    if (D_8033B6F0[1][c->cameraID].unk1C[1] != 0) {
        D_8033B6F0[1][c->cameraID].unk1C[1] += 0x100;
    }

    sp28 = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + D_8033B6F0[3][c->cameraID].unk1C[1]
           + D_8033B6F0[1][c->cameraID].unk1C[1];
    vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, sp2C, sp2A, sp28);
}

CmdRet CutsceneCapSwitchPress0_5(struct LevelCamera *c) {
    rotate_and_move_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, 0, -0x20, 0);
}
...
CmdRet CutsceneCapSwitchPress0_2(struct LevelCamera *c) {
    ...
    approach_f32_exponential_bool(&c->focus[0], (&gPlayerStatusForCamera[c->cameraID])->pos[0], 0.1f);
    approach_f32_exponential_bool(&c->focus[1], (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 110.f,
                                  0.1f);
    approach_f32_exponential_bool(&c->focus[2], (&gPlayerStatusForCamera[c->cameraID])->pos[2], 0.1f);
}

CmdRet CutsceneCapSwitchPress0_3(struct LevelCamera *c) {
    vec3f_copy(c->focus, (&gPlayerStatusForCamera[c->cameraID])->pos);
    c->focus[1] += 110.f;
    camera_approach_s16_symmetric_bool(&D_8033B6F0[0][c->cameraID].unk1C[1], 0x800, 0x20);
    rotate_camera(c, D_8033B6F0[0][c->cameraID].unk1C[0], D_8033B6F0[0][c->cameraID].unk1C[1]);
}

CmdRet CutsceneCapSwitchPress0_6(UNUSED struct LevelCamera *c) {
    create_dialog_box_with_response(gCutsceneFocus[c->cameraID]->oBehParams2ndByte + 10);
}
...
CmdRet CutsceneCapSwitchPress0(struct LevelCamera *c) {
    ...
    if (gDialogResponse != 0) {
        D_8033B6F0[4][c->cameraID].unk1C[0] = gDialogResponse;
    }

    if ((get_dialog_id() == -1) && (D_8033B6F0[4][c->cameraID].unk1C[0] != 0)) {
        D_8032CFFC[c->cameraID] = D_8033B6F0[4][c->cameraID].unk1C[0];
        if (D_8033B6F0[4][c->cameraID].unk1C[0] == 1) {
            cap_switch_save(gCutsceneFocus[c->cameraID]->oBehParams2ndByte);
        }
        func_8028FAE0(c);
        init_transitional_movement(c, 30);
    }
...
CmdRet CutsceneUnlockKeyDoor0_1(struct LevelCamera *c) {
    ...
    vec3f_copy(D_8033B6F0[0][c->cameraID].unk4, c->pos);
    vec3f_copy(D_8033B6F0[1][c->cameraID].unk4, c->focus);
    vec3f_set(sp24, -206.f, 108.f, 234.f);
    vec3f_set(sp18, 48.f, 104.f, -193.f);
    set_pos_from_face_angle_and_vec3f(D_8033B6F0[2][c->cameraID].unk4,
                                      (&gPlayerStatusForCamera[c->cameraID])->pos, sp24,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    set_pos_from_face_angle_and_vec3f(D_8033B6F0[3][c->cameraID].unk4,
                                      (&gPlayerStatusForCamera[c->cameraID])->pos, sp18,
                                      (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
}

CmdRet CutsceneUnlockKeyDoor0_2(struct LevelCamera *c) {
    approach_vec3f_exponential(c->pos, D_8033B6F0[2][c->cameraID].unk4, 0.1f, 0.1f, 0.1f);
    approach_vec3f_exponential(c->focus, D_8033B6F0[3][c->cameraID].unk4, 0.1f, 0.1f, 0.1f);
}

CmdRet CutsceneUnlockKeyDoor0_5(UNUSED struct LevelCamera *c) {
    approach_f32_exponential_bool(&D_8033B6F0[3][c->cameraID].unk4[1],
                                  (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 140.f, 0.07f);
}
...
CmdRet CutsceneUnlockKeyDoor0_3(struct LevelCamera *c) {
    approach_vec3f_exponential(c->pos, D_8033B6F0[0][c->cameraID].unk4, 0.1f, 0.1f, 0.1f);
    approach_vec3f_exponential(c->focus, D_8033B6F0[1][c->cameraID].unk4, 0.1f, 0.1f, 0.1f);
}
...
s32 func_80296DDC(struct LevelCamera *a, struct CinematicCameraTable b[],
    ...
    sp20 = func_80287CFC(a->pos, b, &D_8033B6E0[a->cameraID], &D_8033B6E4[a->cameraID]);
    sp1C = func_80287CFC(a->focus, c, &D_8033B6E0[a->cameraID], &D_8033B6E4[a->cameraID]);
...
CmdRet CutsceneIntroPeach4(struct LevelCamera *c) {
    if (get_dialog_id() == -1) {
        vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[3], c->pos);
        vec3f_copy(gCameraStatus[c->cameraID].camFocAndPosCurrAndGoal[2], c->focus);
        gCameraFlags2[c->cameraID] |= (CAM_FLAG_2_SMOOTH_MOVEMENT | CAM_FLAG_2_UNUSED_CUTSCENE_ACTIVE);
        gCutsceneTimer[c->cameraID] = 0x8000;
        c->cutscene = 0;
    }
}
...
CmdRet CutsceneIntroPeach3_2(struct LevelCamera *c) {
    func_80287CFC(c->pos, D_8032DF60, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    func_80287CFC(c->focus, D_8032DFD0, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
}
...
CmdRet CutsceneIntroPeach2(struct LevelCamera *c) {
    ...
    D_8033B6F0[1][c->cameraID].unk4[1] = 400.f;
}
...
CmdRet CutsceneIntroPeach3(struct LevelCamera *c) {
    ...
    approach_f32_exponential_bool(&D_8033B6F0[1][c->cameraID].unk4[1],
                                  80.f + sGeometryForMario[c->cameraID].currFloorHeight
                                      + ((&gPlayerStatusForCamera[c->cameraID])->pos[1]
                                         - sGeometryForMario[c->cameraID].currFloorHeight)
                                            * 1.1f,
                                  0.4f);

    if (c->focus[1] < D_8033B6F0[1][c->cameraID].unk4[1]) {
        c->focus[1] = D_8033B6F0[1][c->cameraID].unk4[1];
    }
...
CmdRet CutsceneEndWaving0(struct LevelCamera *c) {
    ...
    func_80287CFC(c->pos, D_8032E4E4, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    func_80287CFC(c->focus, D_8032E52C, &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    func_80299C60(6, 120, c);
}
...
#undef SET_CREDITS_PRESET
    ...
    func_8028FBD8(D_8033B4E0[c->cameraID], pos);
    func_8028FBD8(D_8033B5E0[c->cameraID], focus);
    func_80287CFC(c->pos, D_8033B4E0[c->cameraID], &D_8033B6E0[c->cameraID], &D_8033B6E4[c->cameraID]);
    func_80287CFC(c->focus, D_8033B5E0[c->cameraID], &D_8033B6E0[c->cameraID],
                  &D_8033B6E4[c->cameraID]);
...
CmdRet CutsceneSlidingDoorsOpen0_1(struct LevelCamera *c) {
    ...
    vec3f_get_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, &dist, &pitch, &yaw);

    if (dist < 500.f) {
        dist = 500.f;
        yaw = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + 0x8800;
        pitch = 0x800;
    }

    vec3f_set_dist_and_angle((&gPlayerStatusForCamera[c->cameraID])->pos, c->pos, dist, pitch, yaw);
}

CmdRet CutsceneSlidingDoorsOpen0_2(UNUSED struct LevelCamera *c) {
    vec3f_copy(D_8033B6F0[1][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    vec3s_copy(D_8033B6F0[0][c->cameraID].unk1C, (&gPlayerStatusForCamera[c->cameraID])->faceAngle);
    vec3f_set(D_8033B6F0[0][c->cameraID].unk4, 80.f, 325.f, 200.f);
}

CmdRet CutsceneSlidingDoorsOpen0_3(UNUSED struct LevelCamera *c) {
    camera_approach_f32_symmetric_bool(&D_8033B6F0[0][c->cameraID].unk4[1], 75.f, 10.f);
}

CmdRet CutsceneSlidingDoorsOpen0_4(UNUSED struct LevelCamera *c) {
    camera_approach_f32_symmetric_bool(&D_8033B6F0[0][c->cameraID].unk4[1], 125.f, 10.f);
}
...
CmdRet CutsceneSlidingDoorsOpen0_5(struct LevelCamera *c) {
    ...
    D_8033B6F0[1][c->cameraID].unk4[0] = (&gPlayerStatusForCamera[c->cameraID])->pos[0];
    D_8033B6F0[1][c->cameraID].unk4[2] = (&gPlayerStatusForCamera[c->cameraID])->pos[2];
    approach_f32_exponential_bool(&D_8033B6F0[0][c->cameraID].unk4[0], 0, 0.1f);
    camera_approach_f32_symmetric_bool(&D_8033B6F0[0][c->cameraID].unk4[2], 125.f, 50.f);
    approach_vec3s_exponential(D_8033B6F0[0][c->cameraID].unk1C,
                               (&gPlayerStatusForCamera[c->cameraID])->faceAngle, 16, 16, 16);
    set_pos_from_face_angle_and_vec3f(sp34, D_8033B6F0[1][c->cameraID].unk4,
                                      D_8033B6F0[0][c->cameraID].unk4,
                                      D_8033B6F0[0][c->cameraID].unk1C);
...
CmdRet CutsceneEnterPainting0(struct LevelCamera *c) {
    ...
    if (ripplingPainting != NULL) {
        ...
        find_floor((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                   (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 50.f,
                   (&gPlayerStatusForCamera[c->cameraID])->pos[2], &floor);
...
CmdRet CutsceneExitPainting80298094(struct LevelCamera *c) {
    ...
    vec3f_set(D_8033B6F0[2][c->cameraID].unk4, 258.f, -352.f, 1189.f);
    vec3f_set(D_8033B6F0[1][c->cameraID].unk4, 65.f, -155.f, 444.f);

    if (gPrevLevel == LEVEL_TTM) {
        D_8033B6F0[1][c->cameraID].unk4[1] = 0.f;
        D_8033B6F0[1][c->cameraID].unk4[2] = 0.f;
    }
    vec3f_copy(D_8033B6F0[0][c->cameraID].unk4, (&gPlayerStatusForCamera[c->cameraID])->pos);
    D_8033B6F0[0][c->cameraID].unk1C[0] = 0;
    D_8033B6F0[0][c->cameraID].unk1C[1] = (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1];
    D_8033B6F0[0][c->cameraID].unk1C[2] = 0;
    set_pos_from_face_angle_and_vec3f(c->focus, D_8033B6F0[0][c->cameraID].unk4,
                                      D_8033B6F0[1][c->cameraID].unk4,
                                      D_8033B6F0[0][c->cameraID].unk1C);
    set_pos_from_face_angle_and_vec3f(c->pos, D_8033B6F0[0][c->cameraID].unk4,
                                      D_8033B6F0[2][c->cameraID].unk4,
                                      D_8033B6F0[0][c->cameraID].unk1C);
...
CmdRet CutsceneExitPainting80298230(struct LevelCamera *c) {
    ...
    approach_f32_exponential_bool(&D_8033B6F0[2][c->cameraID].unk4[0], 178.f, 0.05f);
    approach_f32_exponential_bool(&D_8033B6F0[2][c->cameraID].unk4[2], 889.f, 0.05f);
    set_pos_from_face_angle_and_vec3f(sp1C, D_8033B6F0[0][c->cameraID].unk4,
                                      D_8033B6F0[2][c->cameraID].unk4,
                                      D_8033B6F0[0][c->cameraID].unk1C);
    c->pos[0] = sp1C[0];
    c->pos[2] = sp1C[2];
...
CmdRet CutsceneExitPainting802982CC(struct LevelCamera *c) {
    ...
    vec3f_copy(floorHeight, (&gPlayerStatusForCamera[c->cameraID])->pos);
    floorHeight[1] = find_floor((&gPlayerStatusForCamera[c->cameraID])->pos[0],
                                (&gPlayerStatusForCamera[c->cameraID])->pos[1] + 10.f,
                                (&gPlayerStatusForCamera[c->cameraID])->pos[2], &floor);

    if (floor != NULL) {
        floorHeight[1] = floorHeight[1]
                         + ((&gPlayerStatusForCamera[c->cameraID])->pos[1] - floorHeight[1]) * 0.7f
                         + 125.f;
...
CmdRet Cutscene11Todo_0(struct LevelCamera *c) {
    ...
    vec3s_set(sp20, 0, (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1], 0);
    set_pos_from_face_angle_and_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, sp28, sp20);
...
CmdRet CutsceneEnterCannon1(struct LevelCamera *c) {
    ...
    gCameraFlags2[c->cameraID] |= CAM_FLAG_2_SMOOTH_MOVEMENT;
    camera_approach_s16_symmetric_bool(&D_8033B6F0[1][c->cameraID].unk1C[0], 0, 0x80);
    camera_approach_s16_symmetric_bool(&D_8033B6F0[2][c->cameraID].unk1C[0], 0, 0x80);
    vec3f_set_dist_and_angle(D_8033B6F0[0][c->cameraID].unk4, c->pos,
                             D_8033B6F0[1][c->cameraID].unk4[2], D_8033B6F0[1][c->cameraID].unk1C[0],
                             D_8033B6F0[1][c->cameraID].unk1C[1]);
    D_8033B6F0[1][c->cameraID].unk4[2] =
        approach_f32(D_8033B6F0[1][c->cameraID].unk4[2], 400.f, 5.f, 5.f);
    D_8033B6F0[1][c->cameraID].unk1C[1] += 0x40;
    D_8033B6F0[3][c->cameraID].unk4[1] += 2.f;
    c->pos[1] += D_8033B6F0[3][c->cameraID].unk4[1];

    if ((o = (&gPlayerStatusForCamera[c->cameraID])->usedObj) != NULL) {
        D_8033B6F0[0][c->cameraID].unk4[1] = o->oPosY;
...
CmdRet CutsceneEnterCannon0(struct LevelCamera *c) {
    ...
    if ((o = (&gPlayerStatusForCamera[c->cameraID])->usedObj) != NULL) {
        D_8033B6F0[0][c->cameraID].unk4[0] = o->oPosX;
        D_8033B6F0[0][c->cameraID].unk4[1] = o->oPosY;
        D_8033B6F0[0][c->cameraID].unk4[2] = o->oPosZ;
        D_8033B6F0[0][c->cameraID].unk1C[0] = o->oMoveAnglePitch;
        D_8033B6F0[0][c->cameraID].unk1C[1] = o->oMoveAngleYaw;
        D_8033B6F0[0][c->cameraID].unk1C[2] = o->oMoveAngleRoll;
    }

    vec3f_get_dist_and_angle(D_8033B6F0[0][c->cameraID].unk4, c->pos,
                             &D_8033B6F0[1][c->cameraID].unk4[2], &D_8033B6F0[1][c->cameraID].unk1C[0],
                             &D_8033B6F0[1][c->cameraID].unk1C[1]);
    D_8033B6F0[3][c->cameraID].unk4[1] = 0.f;
    D_8033B6F0[4][c->cameraID].unk4[1] = 0.f;
}
...
CmdRet CutsceneDoor1(struct LevelCamera *c) {
    vec3f_copy(c->pos, D_8033B6F0[0][c->cameraID].unk4);
    vec3f_copy(c->focus, D_8033B6F0[1][c->cameraID].unk4);
}

CmdRet CutsceneDoorWarp1(struct LevelCamera *c) {
    if (((&gPlayerStatusForCamera[c->cameraID])->action != ACT_PULLING_DOOR)
        & ((&gPlayerStatusForCamera[c->cameraID])->action
           != ACT_PUSHING_DOOR)) //! bitwise AND instead of boolean
    {
        gCutsceneTimer[c->cameraID] = 0x8000;
        c->cutscene = 0;
    }
...
CmdRet CutsceneDoor2(struct LevelCamera *c) {
    ...
    func_8028FEDC(c);
    determine_pushing_or_pulling_door(&sp22, c);
    set_focus_position(c, 0.f, 125.f, 0.f, 0);
    vec3s_set(D_8033B6F0[0][c->cameraID].unk1C, 0,
              (&gPlayerStatusForCamera[c->cameraID])->faceAngle[1] + sp22, 0);
    ...
    set_pos_from_face_angle_and_vec3f(c->pos, (&gPlayerStatusForCamera[c->cameraID])->pos, sp24,
                                      D_8033B6F0[0][c->cameraID].unk1C);
}
...
CmdRet CutsceneDoorAB_2(struct LevelCamera *c) {
    ...
    if (((&gPlayerStatusForCamera[c->cameraID])->action != ACT_ENTERING_STAR_DOOR)
        && ((&gPlayerStatusForCamera[c->cameraID])->action != ACT_PULLING_DOOR)
        && ((&gPlayerStatusForCamera[c->cameraID])->action != ACT_PUSHING_DOOR)) {
        gCutsceneTimer[c->cameraID] = 0x8000;
        c->cutscene = 0;
    }
}
...
void handle_cutscenes(struct LevelCamera *c) {
    ...
    sp22 = sYawFocToMario[c->cameraID];
    cutscene = c->cutscene;
    gCameraFlags2[c->cameraID] &= ~CAM_FLAG_2_SMOOTH_MOVEMENT;
    gCameraMovementFlags[c->cameraID] &= ~CAM_MOVE_INTO_C_UP;
...
#define CUTSCENE_TABLE_JUMP(casenum, table)                                                            \
    case casenum:                                                                                      \
        sp20 = table[D_8033B6EA[c->cameraID]].unk4;                                                    \
        (table[D_8033B6EA[c->cameraID]].unk0)(c);                                                      \
        break;
...
#undef CUTSCENE_TABLE_JUMP
    ...
    if ((sp20 != 0) && ((gCutsceneTimer[c->cameraID] & 0x8000) == 0)) {
        if (gCutsceneTimer[c->cameraID] < 0x3FFF) {
            gCutsceneTimer[c->cameraID] += 1;
        }
        if (gCutsceneTimer[c->cameraID] == sp20) {
            D_8033B6EA[c->cameraID] += 1;
            gCutsceneTimer[c->cameraID] = 0;
        }
    } else {
        (&gPlayerStatusForCamera[c->cameraID])->unk1C[1] = 0;
    ...
    if ((c->cutscene == 0) && (cutscene != 0)) {
        gCutsceneNumber[c->cameraID] = cutscene;
    }
}

s32 call_cutscene_func_in_time_range(CameraCommandProc func, struct LevelCamera *c, s16 start,
                                     s16 end) {
    if (start <= gCutsceneTimer[c->cameraID]) {
        if ((end == -1) || (end >= gCutsceneTimer[c->cameraID])) {
            func(c);
        }
    }
    return 0;
...
s32 func_80299C60(s32 a, s16 b, struct LevelCamera *c) {
    if (b == gCutsceneTimer[c->cameraID]) {
        sCutscenePhase[c->cameraID] = a;
    }
    return 0;
}

void func_80299C98(s16 a, s16 b, s16 c, struct LevelCamera *d) {
    if (a > D_8033B230[d->cameraID].unk10) {
        D_8033B230[d->cameraID].unk10 = a;
        D_8033B230[d->cameraID].unk18 = b;
        D_8033B230[d->cameraID].unk16 = c;
    }
}

void func_80299D00(s16 a, s16 b, s16 c, f32 d, f32 e, f32 f, f32 g) { // this is fine i guess
    a = func_80289738(a, d, e, f, g, gMarioStates[gMarioObject->oAnimState].thisPlayerCamera);

    if (a != 0) {
        if (a > D_8033B230[gMarioObject->oAnimState]
                    .unk10) // literally use the function above you silly nintendo, smh
        {
            D_8033B230[gMarioObject->oAnimState].unk10 = a;
            D_8033B230[gMarioObject->oAnimState].unk18 = b;
            D_8033B230[gMarioObject->oAnimState].unk16 = c;
        }
    }
}
...
void func_80299DB4(struct GraphNodeCamera *a) {
    int i;
    for (i = 0; i < activePlayers; i++) {
        if (D_8033B230[i].unk10 != 0.f) {
            D_8033B230[i].unk8 = coss(D_8033B230[i].unk14) * D_8033B230[i].unk10 / 256;
            D_8033B230[i].unk14 += D_8033B230[i].unk16;
            camera_approach_f32_symmetric_bool(&D_8033B230[i].unk10, 0.f, D_8033B230[i].unk18);
            a->from[0] += D_8033B230[i].unk8;
        } else {
            D_8033B230[i].unk14 = 0;
        }
    }
}

static void unused_deactivate_sleeping_camera(struct MarioState *m) {
    gCameraFlags2[m->thisPlayerCamera->cameraID] &= ~CAM_FLAG_2_SLEEPING;
}

void set_fov_30(struct MarioState *m) {
    D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView = 30.f;
}

void approach_fov_20(struct MarioState *m) {
    camera_approach_f32_symmetric_bool(&D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView, 20.f,
                                       0.3f);
}

void set_fov_45(struct MarioState *m) {
    D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView = 35.f;
}

void set_fov_29(struct MarioState *m) {
    D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView = 29.f;
}

void zoom_fov_30(struct MarioState *m) {
    // Pretty sure approach_f32_exponential_bool would do a much nicer job here, but you do you,
    // Nintendo.
    camera_approach_f32_symmetric_bool(&D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView, 30.f,
                                       (30.f - D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView)
                                           / 60.f);
}
...
void zoom_fov_for_sleep(struct MarioState *m) {
    ...
    if ((m->action == ACT_SLEEPING) || (m->action == ACT_START_SLEEPING)) {
        camera_approach_f32_symmetric_bool(
            &D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView, 30.f,
            (30.f - D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView) / 30.f);
        gCameraFlags2[m->thisPlayerCamera->cameraID] |= CAM_FLAG_2_SLEEPING;
    } else {
        camera_approach_f32_symmetric_bool(
            &D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView, 35.f,
            (35.f - D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView) / 30.f);
        D_8033B230[m->thisPlayerCamera->cameraID].unkC = 0;
    }
    if (m->thisPlayerCamera->cutscene == CUTSCENE_0F_TODO) {
        D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView = 35.f;
    }
}
...
void approach_fov_60(UNUSED struct MarioState *m) {
    camera_approach_f32_symmetric_bool(&D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView, 60.f,
                                       1.f);
}

void approach_fov_45(struct MarioState *m) {
    f32 targetFoV = D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView;

    if ((m->thisPlayerCamera->currPreset == CAMERA_PRESET_FIXED_REF_POINT)
    ...
    D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView =
        approach_f32(D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView, targetFoV, 2.f, 2.f);
}

void approach_fov_80(UNUSED struct MarioState *m) {
    camera_approach_f32_symmetric_bool(&D_8033B230[m->thisPlayerCamera->cameraID].fieldOfView, 80.f,
                                       3.5f);
}
...
s32 geo_camera_fov(s32 a, struct GraphNodeCamera *b, UNUSED struct AllocOnlyPool *c) {
    ...
    sp24->from[0] = D_8033B230[0].fieldOfView;
    func_80299DB4(sp24);
    return 0;
}

void set_fov_function(u8 a, struct LevelCamera *c) {
    D_8033B230[c->cameraID].unk0 = a;
}

void func_8029A494(u8 a, struct LevelCamera *c) {
    switch (a) {
        case 1:
            func_80299C98(0x100, 0x30, -0x8000, c);
            break;
        case 2:
            func_80299C98(0x400, 0x20, 0x4000, c);
            break;
    }
}
